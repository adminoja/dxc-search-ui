...
export class ThailandPassportService implements IManageService, IManageSingleReport {

  headers: string;
  arrRequestors: any;
  url: any;
  baseUrl: string = environment.Dxc_Model_Dca_Moi_Thailand_Passport[0].url.production;
  ...
  filters(filter: string, name: string, lname?: string[], data?: any, latsName?: string[]) {
    ...
    return this.http.get(`${this.baseUrl}/${filter}/moi-dca-thailand-passport`, httpOptions);
    // return this.http.get('assets/data/dca-thailand-passport.json');
  }
