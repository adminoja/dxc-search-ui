...
export interface IDxc_Model_Dopa_Moi_PersonChangenamePrimary {
...
export class Dxc_Model_Dopa_Moi_PersonChangenamePrimary {
  private dataSet: IDxc_Model_Dopa_Moi_PersonChangenamePrimary;
  personchangenameprimary: any;
  reportName: string;
  reportOfDate: string;
  reportOfTime: string;
  constructor(selectData: any) {

    this.personchangenameprimary = {
    ...
    this.dataSet = this.personchangenameprimary;
  }
  ...
  getData(): any {
    return this.personchangenameprimary;
  }
     ...
     */
  public get $dataSet(): IDxc_Model_Dopa_Moi_PersonChangenamePrimary {
    return this.dataSet;
  }
     ...
     */
  public set $dataSet(value: IDxc_Model_Dopa_Moi_PersonChangenamePrimary) {
    this.dataSet = value;
  }
