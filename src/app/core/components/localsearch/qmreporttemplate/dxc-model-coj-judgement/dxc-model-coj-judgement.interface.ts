...
export interface IReportCojJudgement {
    model: IDxc_Model_Coj_Judgement;
}

@Injectable()
export class CojJudgementMetadata {
    reportName: string;
    reportOfTime: string;
    reportOfDate: string;
    html: string;
    constructor() {}
    public getHtml(selectData: IDxc_Model_Coj_Judgement, title: string) {
    ...
    public viewgetHtml(selectData: IDxc_Model_Coj_Judgement, title: string) {
            ...
            <body>
                <div>
                    ...
                    <div class="ml-3">
                        ...
                        <div class="row">
                            <div class="col-3">
                                <p class="text-white font-20">ดาวน์โหลดไฟล์</p>
                            </div>
                            <div class="col-3">
                                <p><a type="button" class="btn btn-info  font-20" href="${selectData.token_fileId}" target ="_blank">ดาวน์โหลดไฟล์ <i class="mdi mdi-download"></i></a></p>
                            </div>
                        </div>
                    </div>
                </div>
