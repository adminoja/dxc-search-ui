...
export interface IReportRtpArrestWarrant {
  model: IDxc_Model_Rtp_ArrestWarrant;
}

@Injectable()
export class RtpArrestWarrantMetadata {
  html: string;
  reportName: string;
  reportOfTime: string;
  reportOfDate: string;
  private results: IDxc_Model_Rtp_ArrestWarrant[];
  ...
  public getHtml(selectData: IDxc_Model_Rtp_ArrestWarrant, title: string) {
  ...
  ${selectData.wartermarks}
    <div>
      ...
      <div class="ml-3">
        ...
        <div class="col-9"></div>
          <div class="col">
            <p class="text-white font-20">รหัสนำจับ</p>
          </div>
          <div class="col">
            <p class="text-success font-20">${selectData.warrantNumber}</p>
          </div>
        </div>

        <div class="row">
          <div class="col-3">
            <p class="text-white font-20">ผู้ต้องหา</p>
          </div>
          <div class="col-9">
            <p class="text-success font-20">${selectData.subjectFullName}</p>
          </div>
        </div>
        <div class="row">
          <div class="col-3">
            <p class="text-white font-20">วันประกาศ</p>
          </div>
          <div class="col-3">
            <p class="text-success font-20">${selectData.effectiveDate}</p>
          </div>
          <div class="col-3">
            <p class="text-white font-20">วันที่สิ้นสุด</p>
          </div>
          <div class="col-3">
            <p class="text-success font-20">${selectData.expirationDate}</p>
          </div>
        </div>
        <div class="row">
          <div class="col-3">
        ...
        <div class="row">
          <div class="col-3">
            <p class="text-white font-20">คดีดำ</p>
          </div>
          <div class="col-3">
            <p class="text-success font-20">${selectData.undecidedCaseId}</p>
          </div>
          <div class="col-3">
            <p class="text-white font-20">คดีแดง</p>
          </div>
          <div class="col-3">
        ...
        <div class="row">
          ...
          <div class="col-9">
            <p class="text-success font-20">${selectData.policeCaseNumber}</p>
          </div>
        </div>
        <div class="row">
          <div class="col-3">
            <p class="text-white font-20">ชื่อพนักงานสืบสวน</p>
          </div>
          <div class="col-9">
            <p class="text-success font-20">${selectData.policeFullName}</p>
          </div>
        </div>
        <div class="row">
          <div class="col-3">
            <p class="text-white font-20">หน่วยงานที่ออกหมายจับ</p>
          </div>
          <div class="col-9">
            <p class="text-success font-20">${selectData.policeCaseOffice}</p>
          </div>
        </div>
      </div>
    </div>
...
`;
  ...
  public viewgetHtml(selectData: IDxc_Model_Rtp_ArrestWarrant, title: string) {
...
<body>
  ...
  public getSearchData() {
    const schema = 'rtp-arrest-warrant';
  ...
  //                 ${this.changeNull(this.results[i].accusedsFullName)}
  //             </span>&nbsp;&nbsp;
  ...
  //           </strong>&nbsp;&nbsp;
  //             <span class="report-field-value" style="text-decoration:underline">
  //                 ${this.changeNull(this.results[i].warrantNumber)}
  //             </span>&nbsp;&nbsp;
  //           <strong class="report-field-title">ชื่อสถานี
  //           </strong>&nbsp;&nbsp;
  //             <span class="report-field-value" style="text-decoration:underline">
  //                 ${this.changeNull(this.results[i].stationName)}
  //             </span>&nbsp;&nbsp;
  //           <strong class="report-field-title">บช./ภาค
  //           </strong>&nbsp;&nbsp;
  //             <span class="report-field-value" style="text-decoration:underline">
  //                   ${this.changeNull(this.results[i].regionalHqt)}
  //             </span>&nbsp;&nbsp;
   ...
   */
  public get $results(): IDxc_Model_Rtp_ArrestWarrant[] {
    return this.results;
  }
   ...
   */
  public set $results(value: IDxc_Model_Rtp_ArrestWarrant[]) {
    this.results = value;
  }
