import { IDxc_Model_Dopa_Moi_PersonChangenamePrimary } from '../../../../shared/models/Dxc_Model_Dopa_Moi_PersonChangenamePrimary';
import * as moment from 'moment';
import { Injectable } from "@angular/core";
export interface IReportDopaMoiPersonChangenamePrimary {
    model: IDxc_Model_Dopa_Moi_PersonChangenamePrimary;
}

@Injectable()
export class DopaMoiPersonChangenamePrimaryMetadata {
    private results: IDxc_Model_Dopa_Moi_PersonChangenamePrimary[];
    private obj: string;
    ...
    public getHtml(selectData: IDxc_Model_Dopa_Moi_PersonChangenamePrimary, title: string) {
                ...
                <div>
                    <div class="ml-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <p class="text-white font-20">ชื่อสกุลที่ร่วมใช้</p>
                            </div>
                            <div class="col-3">
    ...
    public viewgetHtml(selectData: IDxc_Model_Dopa_Moi_PersonChangenamePrimary, title: string) {
        return (this.html = `<html>
            <head>
                ...
                <script>
                    $(document).ready(function() {
                        $('#confirmDopaMoiPersonChangenamePrimary').click(function(){
                            $('#dopaMoiPersonChangenamePrimary').modal('toggle');
                            $('#dopaMoiPersonChangenamePrimary').on('hidden.bs.modal', function () {
                        ...
                        $('#closeDopaMoiPersonChangenamePrimary').click(function(){
                            $('#dopaMoiPersonChangenamePrimary').modal('toggle');
                            $('#dopaMoiPersonChangenamePrimary').on('hidden.bs.modal', function () {
                                $('body').addClass('modal-open');
                            });
                        });
                        $("#dopaMoiPersonChangenamePrimary").modal({
                            show: false,
                            backdrop: 'static'
                        });
                        $("#clickDopaMoiPersonChangenamePrimary").click(function() {
                        $("#dopaMoiPersonChangenamePrimary").modal("show");
                        });
                    });
                </script>
            </head>
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <p class="text-success font-20">
                                    <a class="text-success font-20" id="clickDopaMoiPersonChangenamePrimary" type="button">
            ...
            <div id="dopaMoiPersonChangenamePrimary" class="modal fade" tabindex="-1" data-backdrop="static" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" id="closeDopaMoiPersonChangenamePrimary" class="btn btn-danger">ยกเลิก</button>
                            <a id="confirmDopaMoiPersonChangenamePrimary" class="btn btn-primary" target="_blank" href="#/dxcui0014/dxcui0018/%E0%B8%A3%E0%B8%B2%E0%B8%A2%E0%B8%87%E0%B8%B2%E0%B8%99%20Single%20Report/${selectData.citizenCardNumber}/0/0/0/0/0">ตกลง</a>				
                        </div>
                    </div>
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
    ...
    public viewgetHtmlSingleReport(selectData: IDxc_Model_Dopa_Moi_PersonChangenamePrimary, title: string) {
        return (this.html = `<html>
            <head>
                <meta http-equiv='Content-Type' content='text/html; charset=utf-8' />
            </head>
    ...
    public getSearchData() {
        ...
        if (localStorage.getItem(schema + 'Results') === '[]' || localStorage.getItem(schema + 'Results') === null) {
            ...
            console.log('dopa-moi-dopa-person-changename-primaryResults' + this.results);
        }
    }
    ...
    public getnormalPdf() {
        ...
        <div class="col-md-11"class="row card singlereport-timeline-item list-normal-design-head-collapse">
            ...
            <span class="list-normal-design-underline departdata">การจดทะเบียนเปลี่ยนชื่อตัว (Linkage) </span>
        ...
        for (let i = 0; i < this.results.length; i++) {
            ...
            <span class="list-normal-design-underline depart">การจดทะเบียนเปลี่ยนชื่อตัว (Linkage)</span>
    ...
    /**
     * Getter $results
     * @return {IDxc_Model_Dopa_Moi_PersonChangenamePrimary[]}
     */
    public get $results(): IDxc_Model_Dopa_Moi_PersonChangenamePrimary[] {
        return this.results;
    }
    ...
    /**
     * Setter $results
     * @param {IDxc_Model_Dopa_Moi_PersonChangenamePrimary[]} value
     */
    public set $results(value: IDxc_Model_Dopa_Moi_PersonChangenamePrimary[]) {
        this.results = value;
    }
