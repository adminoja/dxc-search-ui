...
export interface IReportDocReleasedPrisoners {
    model: IDxc_Model_Doc_ReleasedPrisoners;
}

@Injectable()
export class DocReleasedPrisonersMetadata {
    private results: IDxc_Model_Doc_ReleasedPrisoners[];
    private obj: string;
    ...
    public getHtml(selectData: IDxc_Model_Doc_ReleasedPrisoners, title: string) {
              ...
              <div>
                ...
                <div class="ml-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3"></div>
                        <div class="col-3">
                            <p class="text-white font-20">เลขที่นักโทษ</p>
                        </div>
                        <div class="col-3">
                            <p class="text-success font-20">${selectData.prisonerId}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <p class="text-white font-20">สกุล</p>
                        </div>
                        <div class="col-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <p class="text-success font-20">${selectData.religious}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-3">
                        ...
                        <div class="col-9">
                            <p class="text-success font-20">บ้านเลขที่ ${selectData.addressNoText}
                            ...
                            จังหวัด ${selectData.addressProvinceText} รหัสไปรษณีย์ ${selectData.addressPostCode}
                            </p>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <p class="text-success font-20">${selectData.educationLevel}</p>
                        </div>
                        <div class="col-3">
                            <p class="text-white font-20">จำนวนครั้งที่เคยทำผิดวินัย</p>
                        </div>
                        <div class="col-3">
                            <p class="text-success font-20">${selectData.amountOfTimesBreakDiscipline}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-3">
                            <p class="text-white font-20">โทษฐาน</p>
                        </div>
                        <div class="col-3">
                            <p class="text-success font-20">${selectData.allegation}</p>
                        </div>
                        <div class="col-3">
                            <p class="text-white font-20">ผลของคำสั่งศาล</p>
                        </div>
                        <div class="col-3">
                    ...
                    <div class="row">
                        <div class="col-3">
                            <p class="text-white font-20">วันที่ได้รับโทษ</p>
                        </div>
                        <div class="col-3">
                            <p class="text-success font-20">${selectData.sentenceDate}</p>
                        </div>
                        <div class="col-3">
                            <p class="text-white font-20">วันที่ปล่อย</p>
                        </div>
                        <div class="col-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <p class="text-success font-20">${selectData.prisonName}</p>
                        </div>
                        <div class="col-3">
    ...
    public viewgetHtml(selectData: IDxc_Model_Doc_ReleasedPrisoners, title: string) {
          ...
          <head>
            ...
            <script>
              $(document).ready(function() {
                $('#confirmDocReleasedPrisoners').click(function(){
                  $('#docReleasedPrisoners').modal('toggle'); 
                });
                $('#close').click(function(){
                  $('#docReleasedPrisoners').modal('toggle');  
                });
                $('#closeDocReleasedPrisoners').click(function(){
                  $('#docReleasedPrisoners').modal('toggle');  
                });
                $("#docReleasedPrisoners").modal({
                  show: false,
                  backdrop: 'static'
                });
                $("#clickDocReleasedPrisoners").click(function() {
                $("#docReleasedPrisoners").modal("show");             
                });
              });
            </script>
          </head>
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <p class="text-success font-20">
                                <a class="text-success font-20" id="clickDocReleasedPrisoners" type="button">
            ...
            <div id="docReleasedPrisoners" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <button type="button" id="closeDocReleasedPrisoners" class="btn btn-danger">ยกเลิก</button>
                    <a id="confirmDocReleasedPrisoners" class="btn btn-primary" target="_blank" href="#/dxcui0014/dxcui0018/%E0%B8%A3%E0%B8%B2%E0%B8%A2%E0%B8%87%E0%B8%B2%E0%B8%99%20Single%20Report/${selectData.citizenCardNumber}/0/0/0/0/0">ตกลง</a>				
                  </div>
                </div>
              </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
    ...
    public viewgetviewgetHtmlSingleReportHtml(selectData: IDxc_Model_Doc_ReleasedPrisoners, title: string) {
    ...
    public getSearchData() {
        const schema = 'doc-released-prisoners';
        ...
        if (localStorage.getItem(schema + 'Results') === '[]'
          ...
          console.log('doc-released-prisonersObj' + this.obj);
      ...
      public getallegationPdf() {
        ...
        if (localStorage.getItem(schema + 'Results') === '[]' ||
          ...
          this.allegationPdfCount = `<div class="col-md-11"
              ...
              <span class="list-normal-design-underline departdata">ฐานข้อมูลบุคคลพ้นโทษ (อยู่ระหว่างการทดสอบ) (อยู่ระหว่างการทดสอบ) </span>
            ...
            this.allegationPdf.push(`
              <div class="col-md-11">
                ...
                <div style="padding-left:15px;">
                  ...
                  <span class="report-field-value" style="text-decoration:underline">
                  ${this.changeNull(this.results[i].nationality)}</span>&nbsp;&nbsp;
                  <strong class="report-field-title">วันที่ได้รับโทษ</strong>&nbsp;&nbsp;
                  <span class="report-field-value" style="text-decoration:underline">
                  ${this.changeNull(this.results[i].sentenceDate)}</span>&nbsp;&nbsp;
                  <strong class="report-field-title">วันที่ปล่อย</strong>&nbsp;&nbsp;
                  <span class="report-field-value" style="text-decoration:underline">
                  ${this.changeNull(this.results[i].releaseDate)}</span>&nbsp;&nbsp;
                </div>
              </div>
            </div>${this.loadReportDetail()}`);
            console.log('doc-released-prisonersResults' + this.allegationPdf[i]);
          }
          console.log('1.2');
        }
      }
     ...
     */
	public get $results(): IDxc_Model_Doc_ReleasedPrisoners[] {
		return this.results;
	}
     ...
     */
	public set $results(value: IDxc_Model_Doc_ReleasedPrisoners[]) {
		this.results = value;
	}
