...
export interface IReportDopaMoiAddresses {
  model: IDxc_Model_Dopa_Moi_Addresses;
}

@Injectable()
export class DopaMoiAddressesMetadata {

  private results: IDxc_Model_Dopa_Moi_Addresses[];
  private obj: string;
  ...
  private resultsContact: IDxc_Model_Dopa_Moi_Addresses[];
  ...
  public getHtml(selectData: IDxc_Model_Dopa_Moi_Addresses, title: string) {
        ...
        <body>
          ...
          <div>
            ...
            <div class="ml-3">
                  ...
                  <div class="row">
                    <div class="col-3">
                      <p class="text-white font-20">เลขรหัสสำนักทะเบียน</p>
                    </div>
                    <div class="col-3">
                      <p class="text-success font-20">${selectData.rcodeCode}</p>
                    </div>
                    <div class="col-3">
                      <p class="text-white font-20">ชื่อสำนักทะเบียน</p>
                    </div>
                    <div class="col-3">
                      <p class="text-success font-20">${selectData.rcodeDesc}</p>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-3">
                      <p class="text-white font-20">เลขรหัสประเภทบ้าน</p>
                    </div>
                    <div class="col-3">
                      <p class="text-success font-20">${selectData.houseType}</p>
                    </div>
                    <div class="col-3">
                      <p class="text-white font-20">ประเภทบ้าน</p>
                    </div>
                    <div class="col-3">
                      <p class="text-success font-20">${selectData.houseTypeDesc}</p>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-3">
                  ...
                  <div class="row">
                    ...
                    <div class="col-3">
                      <p class="text-success font-20">${selectData.villageNo}</p>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-3">
                    ...
                    <div class="col-3">
                      <p class="text-success font-20">${selectData.alleyWayDesc}</p>
                    </div>
                    <div class="col-3">
                      <p class="text-white font-20">ซอย</p>
                    </div>
                    <div class="col-3">
                      <p class="text-success font-20">${selectData.alleyDesc}</p>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-3">
                    ...
                    <div class="col-3">
                      <p class="text-success font-20">${selectData.roadDesc}</p>
                    </div>
                    <div class="col-3">
                      <p class="text-white font-20">ตําบล</p>
                    </div>
                    <div class="col-3">
                      <p class="text-success font-20">${selectData.subdistrictDesc}</p>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-3">
  ...
  public viewgetHtml(selectData: IDxc_Model_Dopa_Moi_Addresses, title: string) {
    ...
    return this.html = `<html>
          ...
          <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
            ...
            <script>
              $(document).ready(function() {
                $('#confirmDopaMoiAddress').click(function(){
                  $('#dopaMoiAddress').modal('toggle'); 
                  $('#dopaMoiAddress').on('hidden.bs.modal', function () {
                ...
                $('#closeDopaMoiAddress').click(function(){
                  $('#dopaMoiAddress').modal('toggle'); 
                  $('#dopaMoiAddress').on('hidden.bs.modal', function () {
                      $('body').addClass('modal-open');
                  }); 
                });
                $("#dopaMoiAddress").modal({
                  show: false,
                  backdrop: 'static'
                });
                $("#clickDopaMoiAddress").click(function() {
                $("#dopaMoiAddress").modal("show");             
                });
              });
            </script>
        </head>
                  ...
                  <div class="row">
                    ...
                    <div class="col-3">
                      <p class="text-success font-20">
                        <a class="text-success font-20" id="clickDopaMoiAddress" type="button">
        ...
        <div id="dopaMoiAddress" class="modal fade" tabindex="-1" data-backdrop="static" role="dialog" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" id="closeDopaMoiAddress" class="btn btn-danger">ยกเลิก</button>
                <a id="confirmDopaMoiAddress" class="btn btn-primary" target="_blank" href="#/dxcui0014/dxcui0018/%E0%B8%A3%E0%B8%B2%E0%B8%A2%E0%B8%87%E0%B8%B2%E0%B8%99%20Single%20Report/${selectData.citizenCardNumber}/0/0/0/0/0">ตกลง</a>				
              </div>
            </div>
          </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
  ...
  public viewgetHtmlSingleReport(selectData: IDxc_Model_Dopa_Moi_Addresses, title: string) {
  ...
  public getSearchData() {
    const schema = 'dopa-moi-dopa-addresses';
   ...
   */
  public get $results(): IDxc_Model_Dopa_Moi_Addresses[] {
      return this.results;
  }
   ...
   */
  public set $results(value: IDxc_Model_Dopa_Moi_Addresses[]) {
    this.results = value;
  }
  ...
  public get $resultsContact(): IDxc_Model_Dopa_Moi_Addresses[] {
    return this.resultsContact;
  }
  public set $resultsContact(value: IDxc_Model_Dopa_Moi_Addresses[]) {
