import { Dxc_Model_Doc_Prisoner_Bankrupt } from '../../../../shared/models/Dxc_Model_Doc_Prisoner_Bankrupt';
import { Utils } from '../../../../shared/utils/Utils';
import * as moment from 'moment';
import { environment } from 'src/environments/environment';
import { Injectable } from "@angular/core";

export interface IReportDocPrisonerBankrupt {
  model: Dxc_Model_Doc_Prisoner_Bankrupt;
}

@Injectable()
export class DocPrisonerBankruptMetadata {

  private results: Dxc_Model_Doc_Prisoner_Bankrupt[];
  private obj: string;
  ...
  reportOfDate: string;
  html: string;
  private resultsContact: Dxc_Model_Doc_Prisoner_Bankrupt[];
  ...
  public getHtml(selectData: Dxc_Model_Doc_Prisoner_Bankrupt, title: string) {
            ...
            <div>
                ...
                <div class="ml-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <p class="text-success font-20">${selectData.addressNoText}</p>
                        </div>
                        <div class="col-3">
                            <p class="text-white font-20">หมู่</p>
                        </div>
                        <div class="col-3">
                            <p class="text-success font-20">${selectData.addressMooText}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-3">
                        ...
                        <div class="col-3">
                            <p class="text-success font-20">${selectData.addressSoiText}</p>
                        </div>
                        <div class="col-3">
                            <p class="text-white font-20">ถนน</p>
                        </div>
                        <div class="col-3">
                            <p class="text-success font-20">${selectData.addressRoadText}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-3">
                        ...
                        <div class="col-3">
                            <p class="text-success font-20">${selectData.addressMooBanText}</p>
                        </div>
                        <div class="col-3">
                            <p class="text-white font-20">ตำบล</p>
                        </div>
                        <div class="col-3">
                            <p class="text-success font-20">${selectData.addressTumbonText}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-3">
                        ...
                        <div class="col-3">
                            <p class="text-success font-20">${selectData.addressAmphurText}</p>
                        </div>
                        <div class="col-3">
                            <p class="text-white font-20">จังหวัด</p>
                        </div>
                        <div class="col-3">
                            <p class="text-success font-20">${selectData.addressProvinceText}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-3">
                        ...
                        <div class="col-3">
                            <p class="text-success font-20">${selectData.addressPostCode}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-3">
                            <p class="text-white font-20"><u>ชื่อบิดาและมารดา</u></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-3">
                    ...
                    <div class="row">
                        <div class="col-3">
                            <p class="text-white font-20">เลขคดีดำล้มละลาย</p>
                        </div>
                        <div class="col-3">
                            <p class="text-success font-20">${selectData.blackCaseNumber}/${selectData.blackCaseYear}</p>
                        </div>
                        <div class="col-3">
                            <p class="text-white font-20">เลขคดีแดงล้มละลาย</p>
                        </div>
                        <div class="col-3">
                            <p class="text-success font-20">${selectData.redCaseNumber}/${selectData.redCaseYear}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-3">
  ...
  public viewgetHtml(selectData: Dxc_Model_Doc_Prisoner_Bankrupt, title: string) {
        ...
        <div>
            ...
            <div class="ml-3">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-3">
                        <p class="text-success font-20">
                            <a id="clickDocPrisonerBankrupt" type="button">
                                <span class="demo-google-material-icon text-success font-20">
                                    ${selectData.citizenCardNumber}<i class="material-icons">link</i>
                                </span>
                            </a>
                        </p>
                    </div>
  ...
  /**
   * Getter $results
   * @return {Dxc_Model_Doc_Prisoner_Bankrupt[]}
   */
  public get $results(): Dxc_Model_Doc_Prisoner_Bankrupt[] {
    return this.results;
  }
  ...
  /**
   * Setter $results
   * @param {Dxc_Model_Doc_Prisoner_Bankrupt[]} value
   */
  public set $results(value: Dxc_Model_Doc_Prisoner_Bankrupt[]) {
    this.results = value;
  }
  ...
  public get $resultsContact(): Dxc_Model_Doc_Prisoner_Bankrupt[] {
    return this.resultsContact;
  }
  public set $resultsContact(value: Dxc_Model_Doc_Prisoner_Bankrupt[]) {
