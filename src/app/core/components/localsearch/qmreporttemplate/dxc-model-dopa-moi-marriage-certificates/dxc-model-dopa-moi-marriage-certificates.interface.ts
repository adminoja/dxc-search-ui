import { IDxc_Model_Moi_Dopa_Marriage_Certificates } from '../../../../shared/models/Dxc_Model_Dopa_Moi_Marriage_Certificates';
import * as moment from 'moment';
import { environment } from 'src/environments/environment';
import { Injectable } from "@angular/core";

export interface IReportDopaMoiMarriageCertificates {
  model: IDxc_Model_Moi_Dopa_Marriage_Certificates;
}

@Injectable()
export class DopaMoiMarriageCertificatesMetadata {
  private results: IDxc_Model_Moi_Dopa_Marriage_Certificates[];
  private obj: string;
  ...
  public getHtml(selectData: IDxc_Model_Moi_Dopa_Marriage_Certificates, title: string) {
          ...
          <div>
            ...
            <div class="ml-3">
              ...
              <div class="row">
                ...
                <div class="col-3">
                    <p class="text-success font-20">${selectData.maleAge}
                </div>
              </div>
              <div class="row">
                <div class="col-3">
              ...
              <div class="row">
                ...
                <div class="col-3">
                    <p class="text-success font-20">
                      <a target="_blank" class="text-success font-20" href="#/dxcui0014/dxcui0018/%E0%B8%A3%E0%B8%B2%E0%B8%A2%E0%B8%87%E0%B8%B2%E0%B8%99%20Single%20Report/${selectData.femalePID}/0/0/0/0/0">
                      ${selectData.femalePID}</a>
                    </p>
                </div>
              </div>
              <div class="row">
              ...
              <div class="row">
                <div class="col-3">
                    <p class="text-white font-20">วันเดือนปีเกิดของฝ่ายหยญิง</p>
                </div>
                <div class="col-3">
...
`;
  ...
  public viewgetHtml(selectData: IDxc_Model_Moi_Dopa_Marriage_Certificates, title: string) {
    ...
    return this.html = `<html>
        <head>
          ...
          <script>
            $(document).ready(function() {
              $('#confirmDopaMoiMarriageCertificates').click(function(){
                $('#dopaMoiMarriageCertificates').modal('toggle'); 
                $('#dopaMoiMarriageCertificates').on('hidden.bs.modal', function () {
              ...
              $('#closeDopaMoiMarriageCertificates').click(function(){
                $('#dopaMoiMarriageCertificates').modal('toggle');  
                $('#dopaMoiMarriageCertificates').on('hidden.bs.modal', function () {
                    $('body').addClass('modal-open');
                });
              });
              $("#dopaMoiMarriageCertificates").modal({
                show: false,
                backdrop: 'static'
              });
              $("#clickDopaMoiMarriageCertificatesMale").click(function() {
              $("#dopaMoiMarriageCertificates").modal("show");             
              });
            });
          </script>
          <script>
          $(document).ready(function() {
            $('#confirmDopaMoiMarriageCertificatesFemale').click(function(){
              $('#dopaMoiMarriageCertificatesFemale').modal('toggle');
              $('#dopaMoiMarriageCertificatesFemale').on('hidden.bs.modal', function () {
                  $('body').addClass('modal-open');
              }); 
            });
            ...
            $('#closeDopaMoiMarriageCertificatesFemale').click(function(){
              $('#dopaMoiMarriageCertificatesFemale').modal('toggle');  
              $('#dopaMoiMarriageCertificatesFemale').on('hidden.bs.modal', function () {
                  $('body').addClass('modal-open');
              });
            });
            $("#dopaMoiMarriageCertificatesFemale").modal({
              show: false,
              backdrop: 'static'
            });
            $("#clickDopaMoiMarriageCertificatesFemale").click(function() {
            $("#dopaMoiMarriageCertificatesFemale").modal("show");             
            });
          });
          </script>
        </head>
          ...
          <div>
            ...
            <div class="ml-3">
              ...
              <div class="row">
                ...
                <div class="col-3">
                    <p class="text-success font-20">
                      <a class="text-success font-20" id="clickDopaMoiMarriageCertificatesMale" type="button">
                      ${selectData.malePID}</a><i class="material-icons">link</i>
                    </p>
                </div>
                <div class="col-3"></div>
                <div class="col-3"></div>
              ...
              <div class="row">
                ...
                <div class="col-3">
                    <p class="text-success font-20">
                      <a class="text-success font-20" id="clickDopaMoiMarriageCertificatesFemale" type="button">
                      ${selectData.femalePID}</a><i class="material-icons">link</i>
                    </p>
                </div>
              </div>
              <div class="row">
        ...
        <div id="dopaMoiMarriageCertificates" class="modal fade" tabindex="-1" data-backdrop="static" role="dialog" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" id="closeDopaMoiMarriageCertificates" class="btn btn-danger">ยกเลิก</button>
                <a id="confirmDopaMoiMarriageCertificates" class="btn btn-primary" target="_blank" href="#/dxcui0014/dxcui0018/%E0%B8%A3%E0%B8%B2%E0%B8%A2%E0%B8%87%E0%B8%B2%E0%B8%99%20Single%20Report/${selectData.malePID}/0/0/0/0/0">ตกลง</a>				
              </div>
            </div>
          </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
        <div id="dopaMoiMarriageCertificatesFemale" class="modal fade" tabindex="-1" data-backdrop="static" role="dialog" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title text-white" id="exampleModalLongTitle">ยืนยันการค้นหา</h4>
              ...
              <div class="modal-footer">
                <button type="button" id="closeDopaMoiMarriageCertificatesFemale" class="btn btn-danger">ยกเลิก</button>
                <a id="confirmDopaMoiMarriageCertificatesFemale" class="btn btn-primary" target="_blank" href="#/dxcui0014/dxcui0018/%E0%B8%A3%E0%B8%B2%E0%B8%A2%E0%B8%87%E0%B8%B2%E0%B8%99%20Single%20Report/${selectData.femalePID}/0/0/0/0/0">ตกลง</a>				
              </div>
            </div>
          </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
  ...
  public viewgetHtmlSingleReport(selectData: IDxc_Model_Moi_Dopa_Marriage_Certificates, title: string) {
  ...
  public getSearchData() {
    // มาจาก env
    const schema = 'dopa-moi-dopa-marriage-certificates';
    //const schema = environment.qm.sub[0]['dopa'].sub[0]['marriagecertificates'].schema;
    if (localStorage.getItem(schema + 'Results') === '[]' || localStorage.getItem(schema + 'Results') === null) {

      console.log('ข้อมูลทะเบียนสมรส (Linkage) search null');
    } else {
      this.show = true;
      ...
      console.log('ข้อมูลทะเบียนสมรส (Linkage) results: ' + this.results);
    }
  }
  public getnormalPdf() {
    const schema = 'dopa-moi-dopa-marriage-certificates';
    ...
    if (localStorage.getItem(schema + 'Results') === '[]' ||
      ...
      this.normalPdf = [];
      console.log('ข้อมูลทะเบียนสมรส (Linkage) PDF nul');
    } else {
      this.obj = localStorage.getItem(schema + 'Results');
      this.results = JSON.parse(this.obj);
      this.count = this.results.length; // นับจำนวนรายการ
      this.normalPdfCount = `<div class="col-md-11"
        ...
        <span class="list-normal-design-underline departdata">ข้อมูลทะเบียนสมรส (Linkage)</span>
      ...
      for (let i = 0; i < this.results.length; i++) {
        this.normalPdf.push(`<div class="col-md-11">
          <div class="section-criminal-results" style="text-indent:25px;
            ...
            <span class="list-normal-design-underline depart">ข้อมูลทะเบียนสมรส (Linkage)</span>
            <div style="padding-left:15px;">
              ...
              <strong class="report-field-title">วันเดือนปีที่จดทะเบียนสมรส</strong>&nbsp;&nbsp;
              <span class="report-field-value" style="text-decoration:underline">${this.formatDate(this.results[i].marryDate)}</span>&nbsp;&nbsp;
              <strong class="report-field-title">สนท.ที่จดทะเบียนสมรส</strong>&nbsp;&nbsp;
              <span class="report-field-value" style="text-decoration:underline">${this.changeNull(this.results[i].marryPlaceDesc)}</span>&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <strong class="report-field-title">จังหวัดที่จดทะเบียนสมรส</strong>&nbsp;&nbsp;
              <span class="report-field-value" style="text-decoration:underline">${this.changeNull(this.results[i].marryPlaceProvince)}</span>&nbsp;&nbsp;
            </div>
          </div>
   ...
   */
  public get $results(): IDxc_Model_Moi_Dopa_Marriage_Certificates[] {
    return this.results;
  }
   ...
   */
  public set $results(value: IDxc_Model_Moi_Dopa_Marriage_Certificates[]) {
    this.results = value;
  }
