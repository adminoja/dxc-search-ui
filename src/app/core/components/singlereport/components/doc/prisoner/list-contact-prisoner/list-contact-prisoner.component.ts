...
@Component({
  selector: 'app-list-contact-prisoner',
  templateUrl: './list-contact-prisoner.component.html',
  styleUrls: ['./list-contact-prisoner.component.scss']
})
export class ListContactPrisonerComponent implements OnInit {
