...
@Component({
  selector: 'app-list-career-coj-arrest-warrants',
  templateUrl: './list-career-coj-arrest-warrants.component.html',
  styleUrls: ['./list-career-coj-arrest-warrants.component.scss']
})
export class ListCareerCojArrestWarrantsComponent implements OnInit {
