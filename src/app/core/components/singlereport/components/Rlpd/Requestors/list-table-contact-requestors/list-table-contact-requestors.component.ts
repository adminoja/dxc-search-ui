...
@Component({
  selector: 'app-list-table-contact-requestors',
  templateUrl: './list-table-contact-requestors.component.html',
  styleUrls: ['./list-table-contact-requestors.component.scss']
})
export class ListTableContactRequestorsComponent implements OnInit {
