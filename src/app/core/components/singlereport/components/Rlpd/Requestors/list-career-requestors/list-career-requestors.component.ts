...
@Component({
  selector: 'app-list-career-requestors',
  templateUrl: './list-career-requestors.component.html',
  styleUrls: ['./list-career-requestors.component.scss']
})
export class ListCareerRequestorsComponent implements OnInit {
