...
@Component({
  selector: 'app-list-table-career-crime-victim-compensation',
  templateUrl: './list-table-career-crime-victim-compensation.component.html',
  styleUrls: ['./list-table-career-crime-victim-compensation.component.scss']
})
export class ListTableCareerCrimeVictimCompensationComponent implements OnInit {
