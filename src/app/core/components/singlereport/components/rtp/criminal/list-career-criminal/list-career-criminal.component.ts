...
@Component({
  selector: 'app-list-career-criminal',
  templateUrl: './list-career-criminal.component.html',
  styleUrls: ['./list-career-criminal.component.scss']
})
export class ListCareerCriminalComponent implements OnInit {
