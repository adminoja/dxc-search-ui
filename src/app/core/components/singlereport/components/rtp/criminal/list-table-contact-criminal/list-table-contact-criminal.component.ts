...
@Component({
  selector: 'app-list-table-contact-criminal',
  templateUrl: './list-table-contact-criminal.component.html',
  styleUrls: ['./list-table-contact-criminal.component.scss']
})
export class ListTableContactCriminalComponent implements OnInit {
