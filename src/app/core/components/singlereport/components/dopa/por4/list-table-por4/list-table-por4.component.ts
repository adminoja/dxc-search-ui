...
import { Dxc_Model_Dopa_MoiDopaPor4Licenses, IDxc_Model_Dopa_MoiDopaPor4Licenses } from 'src/app/core/shared/models/Dxc_Model_Dopa_MoiDopaPor4Licenses';
...
declare var $;
@Component({
  selector: 'app-list-table-por4',
  templateUrl: './list-table-por4.component.html',
  styleUrls: ['./list-table-por4.component.scss'],
  providers: [
    DopaMoiPor4Metadata
  ]
})
export class ListTablePor4Component implements OnInit {
  ...
  openDialog(arrData) {
    ...
    const dialogRef = this.dialog.open(DialogPor4TableDialog, {
      data: {
...
@Component({
  selector: 'dialog-por4-table-dialog',
  templateUrl: 'dialog-por4-table-dialog.html',
})
export class DialogPor4TableDialog {
  constructor(public dialogRef: MatDialogRef<DialogPor4TableDialog>, @Inject(MAT_DIALOG_DATA) public data: any) {
  ...
  open() {
    $(document).ready(function () {
      $("#por4-full-width-modal-table").modal("show");
    });
