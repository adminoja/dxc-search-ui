...
@Component({
  selector: 'app-list-contact-por4',
  templateUrl: './list-contact-por4.component.html',
  styleUrls: ['./list-contact-por4.component.scss']
})
export class ListContactPor4Component implements OnInit {
