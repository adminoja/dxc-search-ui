...
declare var $;
@Component({
  selector: 'app-list-table-persons',
  templateUrl: './list-table-persons.component.html',
  styleUrls: ['./list-table-persons.component.scss']
})
export class ListTableComponent implements OnInit {
  ...
  openDialog(arrData) {
    ...
    const dialogRef = this.dialog.open(DialogContentPersonTableDialog, {
      data: {
...
@Component({
  selector: 'dialog-content-person-table-dialog',
  templateUrl: 'dialog-content-person-table-dialog.html',
})
export class DialogContentPersonTableDialog {
  constructor(public dialogRef: MatDialogRef<DialogContentPersonTableDialog>, @Inject(MAT_DIALOG_DATA) public data: any) {
  ...
  open() {
    $(document).ready(function () {
      $("#person-table-full-width-modal").modal("show");
    });
