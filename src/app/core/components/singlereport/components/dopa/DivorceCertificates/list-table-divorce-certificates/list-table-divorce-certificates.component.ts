...
import { Dxc_Model_Dopa_Moi_Divorce_Certificates, IDxc_Model_Dopa_Moi_Divorce_Certificates } from 'src/app/core/shared/models/Dxc_Model_Dopa_Moi_Divorce_Certificates';
...
declare var $;
@Component({
  selector: 'app-list-table-divorce-certificates',
  templateUrl: './list-table-divorce-certificates.component.html',
  styleUrls: ['./list-table-divorce-certificates.component.scss']
})
export class ListTableDivorceCertificatesComponent implements OnInit {

  moidopaDivorceCertificatesResults: IDxc_Model_Dopa_Moi_Divorce_Certificates[];
  ...
  selectRow(Item: any, title: string, departmentImg: string) {
    ...
    const divorcecertificates = new Dxc_Model_Dopa_Moi_Divorce_Certificates(Item);
    divorcecertificates.setData(Item);
    const dataSet = divorcecertificates.getData();
  ...
  pdfPreviewlocal() {
    ...
    localStorage.setItem('dopa-moi-dopa-divorce-certificates', JSON.stringify(this.selectItem));
  }
  ...
  openDialog(arrData) {
    ...
    const dialogRef = this.dialog.open(DialogContentDivorceCertificatesTableDialog, {
      data: {
...
@Component({
  selector: 'dialog-content-divorce-certificates-table-dialog',
  templateUrl: 'dialog-content-divorce-certificates-table-dialog.html',
})
export class DialogContentDivorceCertificatesTableDialog {
  constructor(public dialogRef: MatDialogRef<DialogContentDivorceCertificatesTableDialog>, @Inject(MAT_DIALOG_DATA) public data: any) {
  ...
  open() {
    $(document).ready(function () {
      $("#divorce-certificates-table-full-width-modal").modal("show");
    });
