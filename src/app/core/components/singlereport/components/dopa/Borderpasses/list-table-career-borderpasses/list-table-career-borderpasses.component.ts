...
@Component({
  selector: 'app-list-table-career-borderpasses',
  templateUrl: './list-table-career-borderpasses.component.html',
  styleUrls: ['./list-table-career-borderpasses.component.scss']
})
export class ListTableCareerBorderpassesComponent implements OnInit {
