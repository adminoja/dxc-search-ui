...
declare var $;
@Component({
  selector: 'app-list-table-borderpasses',
  templateUrl: './list-table-borderpasses.component.html',
  styleUrls: ['./list-table-borderpasses.component.scss']
})
export class ListTableBorderpassesComponent implements OnInit {
  ...
  openDialog(arrData) {
    ...
    const dialogRef = this.dialog.open(DialogContentBorderPassesTableDialog, {
      data: {
...
@Component({
  selector: 'dialog-border-passes-table-dialog',
  templateUrl: 'dialog-border-passes-table-dialog.html',
})
export class DialogContentBorderPassesTableDialog {
  constructor(public dialogRef: MatDialogRef<DialogContentBorderPassesTableDialog>, @Inject(MAT_DIALOG_DATA) public data: any) {
  ...
  open() {
    $(document).ready(function () {
      $("#border-passes-full-width-modal-table").modal("show");
    });
