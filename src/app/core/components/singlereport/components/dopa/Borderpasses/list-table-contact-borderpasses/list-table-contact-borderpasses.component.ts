...
@Component({
  selector: 'app-list-table-contact-borderpasses',
  templateUrl: './list-table-contact-borderpasses.component.html',
  styleUrls: ['./list-table-contact-borderpasses.component.scss']
})
export class ListTableContactBorderpassesComponent implements OnInit {
