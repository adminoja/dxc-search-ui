...
declare var $;
@Component({
  selector: 'app-list-table-person-changename-primary',
  templateUrl: './list-table-person-changename-primary.component.html',
  styleUrls: ['./list-table-person-changename-primary.component.scss']
})
export class ListTablePersonChangenamePrimaryComponent implements OnInit {
  ...
  openDialog(arrData) {
    ...
    const dialogRef = this.dialog.open(DialogContentChangenamePrimaryTableDialog, {
      data: {
...
@Component({
  selector: 'dialog-content-changename-primary-table-dialog',
  templateUrl: 'dialog-content-changename-primary-table-dialog.html',
})
export class DialogContentChangenamePrimaryTableDialog {
  constructor(public dialogRef: MatDialogRef<DialogContentChangenamePrimaryTableDialog>, @Inject(MAT_DIALOG_DATA) public data: any) {
  ...
  open() {
    $(document).ready(function () {
      $("#changename-primary-full-width-modal-table").modal("show");
    });
