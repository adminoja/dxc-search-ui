...
declare var $;
@Component({
  selector: 'app-list-table-marriagecertificates',
  templateUrl: './list-table-marriagecertificates.component.html',
  styleUrls: ['./list-table-marriagecertificates.component.scss']
})
export class ListTableMarriagecertificatesComponent implements OnInit {
  ...
  openDialog(arrData) {
    ...
    const dialogRef = this.dialog.open(DialogContentMarriageCertificatesTableDialog, {
      data: {
...
@Component({
  selector: 'dialog-content-marriage-certificates-table-dialog',
  templateUrl: 'dialog-content-marriage-certificates-table-dialog.html',
})
export class DialogContentMarriageCertificatesTableDialog {
  constructor(public dialogRef: MatDialogRef<DialogContentMarriageCertificatesTableDialog>, @Inject(MAT_DIALOG_DATA) public data: any) {
  ...
  open() {
    $(document).ready(function () {
      $("#marriage-certificates-table-width-modal").modal("show");
    });
