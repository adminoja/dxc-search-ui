...
declare var $;
@Component({
  selector: 'app-list-normal-person-changelastname',
  templateUrl: './list-normal-person-changelastname.component.html',
  styleUrls: ['./list-normal-person-changelastname.component.scss']
})
export class ListNormalPersonChangelastnameComponent implements OnInit {
  ...
  openDialog(arrData) {
    ...
    const dialogRef = this.dialog.open(DialogContentChangelastnameDialog, {
      data: {
...
@Component({
  selector: 'dialog-content-changelastname-dialog',
  templateUrl: 'dialog-content-changelastname-dialog.html',
})
export class DialogContentChangelastnameDialog {
  constructor(public dialogRef: MatDialogRef<DialogContentChangelastnameDialog>, @Inject(MAT_DIALOG_DATA) public data: any) {
  ...
  open() {
    $(document).ready(function () {
      $("#changelastname-full-width-modal").modal("show");
    });
