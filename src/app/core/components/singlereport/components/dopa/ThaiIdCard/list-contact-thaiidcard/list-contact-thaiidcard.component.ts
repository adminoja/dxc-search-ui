...
@Component({
  selector: 'app-list-contact-thaiidcard',
  templateUrl: './list-contact-thaiidcard.component.html',
  styleUrls: ['./list-contact-thaiidcard.component.scss']
})
export class ListContactThaiidcardComponent implements OnInit {
