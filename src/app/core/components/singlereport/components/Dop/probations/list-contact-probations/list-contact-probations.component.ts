...
@Component({
  selector: 'app-list-contact-probations',
  templateUrl: './list-contact-probations.component.html',
  styleUrls: ['./list-contact-probations.component.scss']
})
export class ListContactProbationsComponent implements OnInit {
