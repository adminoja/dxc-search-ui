...
@Component({
  selector: 'app-list-table-contact-charge-subject',
  templateUrl: './list-table-contact-charge-subject.component.html',
  styleUrls: ['./list-table-contact-charge-subject.component.scss']
})
export class ListTableContactChargeSubjectComponent implements OnInit {
