...
@Component({
  selector: 'app-list-career-agoth-charge-victim',
  templateUrl: './list-career-agoth-charge-victim.component.html',
  styleUrls: ['./list-career-agoth-charge-victim.component.scss']
})
export class ListCareerAgothChargeVictimComponent implements OnInit {
