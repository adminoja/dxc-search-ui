...
@Component({
  selector: 'app-list-table-contact-agoth-charge-victim',
  templateUrl: './list-table-contact-agoth-charge-victim.component.html',
  styleUrls: ['./list-table-contact-agoth-charge-victim.component.scss']
})
export class ListTableContactAgothChargeVictimComponent implements OnInit {
