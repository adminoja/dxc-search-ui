...
declare var $;
@Component({
  selector: 'app-list-normal-car-license',
  templateUrl: './list-normal-car-license.component.html',
  styleUrls: ['./list-normal-car-license.component.scss']
})
export class ListNormalCarLicenseComponent implements OnInit {
  ...
  pdfPreviewlocal() {
    ...
    openDialog(arrData) {
      ...
      const dialogRef = this.dialog.open(DialogContentCarLicenseDialog, {
        data: {
...
@Component({
  selector: 'dialog-content-car-license-dialog',
  templateUrl: 'dialog-content-car-license-dialog.html',
})
export class DialogContentCarLicenseDialog {
  constructor(public dialogRef: MatDialogRef<DialogContentCarLicenseDialog>, @Inject(MAT_DIALOG_DATA) public data: any) {
  ...
  open() {
    $(document).ready(function () {
      $("#car-license-full-width-modal").modal("show");
    });
