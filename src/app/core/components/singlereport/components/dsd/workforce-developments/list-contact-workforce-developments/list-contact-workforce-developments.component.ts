...
@Component({
  selector: 'app-list-contact-workforce-developments',
  templateUrl: './list-contact-workforce-developments.component.html',
  styleUrls: ['./list-contact-workforce-developments.component.scss']
})
export class ListContactWorkforceDevelopmentsComponent implements OnInit {
