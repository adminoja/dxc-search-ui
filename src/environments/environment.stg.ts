  ...
  menu: [
    {
      ...
      title: 'Single Report',
      url: '/#/dxcui0014/singlereport'
    },
    // {
    //   icon: 'mdi mdi-file-document-box-search  mdi-24px',
    //   title: 'สืบเสาะพินิจ',
    //   url: '/#/dxcui0014/dxcui00141/สืบเสาะพินิจ'
    // },
    // {
    //   icon: 'mdi mdi-file-document-box-search  mdi-24px',
    //   title: 'สืบเสาะคุมประพฤติ',
    //   url: '/#/dxcui0014/dxcui00141/สืบเสาะคุมประพฤติ'
    // },
    // {
    //   icon: 'mdi mdi-file-document-box-search  mdi-24px',
    //   title: 'สืบเสาะราชทัณฑ์',
    //   url: '/#/dxcui0014/dxcui00141/สืบเสาะราชทัณฑ์'
    // },
    {
...
ซึ่งปัญหานี้กำลังประสานงานเพื่อหาทางแก้ไข`
  ...
  // headerauthen: 'Bearer eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJTdXp1WXpENGNVU3hIbGtvVnRSc2U1cExLSUNyNDdHNnFXQTBpUjVSb2VJIn0.-C4tOC4jeC4nuC4t--C4tOC5hOC4peC4peC4seC4geC4qeC4k--C4tOC4jeC4nuC4t-C4iiIsInBvc2l0aW9uIjoi4LmA4LiI4LmJ4Liy4Lir4LiZ4LmJ4Liy4LiX4Li14LmIIiwiZmFtaWx5X25hbWUiOiLguYDguIjguKPguLTguI3guJ7guLfguIoifQ.Jh394jviJA95hMhahE93mWEnD0_Un08mygKyVwUBULjIv7yP2L-EVTTZoeZqYbwJvKU8KLYNAgUEmEitZuTYrZjNA7W_gcqIYcRC4eayAwOcWTN9s6wuhnOQWuSkUc9I9d6sGJ7gOhG2j_f8j1FhGMvSkNAPieeKAqYWNOtJnLLFlU71RUsgE1RF_tKSdwB-MM8k_ZY0FLoO80aCMm08gaxMbSADVHEQ4cUo_bc-j2Ewip-RNptp7tm7_Vi1_remOl-4P_f0vp-xXMTPC-7xKUiz0VTSJ91QEdst3YBNeE1BCLy3UIiWVFdgNezDXUoKFGG2QpZmQXzPde6Y3gpYfg',
        ...
        djop: {
          ...
          sub: [{
            ...
            juvenileOffender65: {
              ...
              remark1: `มีข้อมูลคดีตั้งแต่ปี พ.ศ.2548 - วันที่ 6 ธันวาคม พ.ศ.2565`,
  ...
  Dxc_Model_Dopa_Citizen: [{
    ...
    'basicSearch': [
      { 'title': 'เลขประจำตัวประชาชน', 'name': 'citizenCardNumber', 'maxlength': '13', 'pattern':'[0-9]{13}' },
  ...
  Dxc_Model_Moi_Dopa_Border_Passes: [{
    ...
    'grid': [{
      'cells': [
        { 'id': 'dateOfReq', 'title': 'วันที่ออกคำร้อง', 'width': '150px', 'align': 'left' },
        { 'id': 'borderPassNo', 'title': 'เลขที่หนังสือผ่านแดน', 'width': '150px', 'align': 'left' },
        { 'id': 'thaiName', 'title': 'ชื่อตัว-ชื่อสกุล ภาษาไทย', 'width': '150px', 'align': 'left' },
        { 'id': 'borderName', 'title': 'ชื่อด่านออกหนังสือผ่านแดน', 'align': 'center', 'width': '70px' },
  ...
  Dxc_Model_Nhso_Moi_Health_Insurance_Rights: [{
    ...
    'basicSearch': [
      { 'title': 'เลขประจำตัวประชาชน', 'name': 'personId', 'maxlength': '13', 'pattern':'[0-9]{13}', 'type':'text', 'keypress':true },
  ...
  Dxc_Model_Oncb_NarcoticOffender: [{
    ...
    'category': 'criminalRecords',
    'url': {
      'production': '/dxc-qm-oncb-narcotic-offender-service/api/qm/v2/oncb/narcotic-offender',
    },
    'queryPattern': {
  ...
  Dxc_Model_Rlpd_CrimeVictimCompensation: [{
    ...
    'basicSearch': [
      { 'title': 'เลขคดี', 'name': 'caseId', 'pattern':'^[0-9/]{1,20}' },
      { 'title': 'เลขประจำตัวประชาชน', 'name': 'victimCitizenId', 'maxlength': '13', 'pattern':'[0-9]{13}', 'type':'text', 'keypress':true },
      { 'title': 'ชื่อ-สกุล', 'name': 'victimAttorneyFullName', 'pattern':'^[a-zA-Z ]+$|^[ก-๏ ]+$' }
    ],
    'grid': [{
      'cells': [
        { 'id': 'caseId', 'title': 'เลขคดี', 'width': '120px', 'align': 'center' },
  ...
  Dxc_Model_Amlo_Moneylaunderingcase: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-amlo-money-laundering-case-service/api/qm/v2/almo/money-laundering-case'
  ...
  Dxc_Model_Led_BankruptcyCase: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-led-bankruptcy-case-service/api/qm/v2/led/bankruptcy-case',
  ...
  Dxc_Model_Mof_Registrant: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-mof-registrant-service/api/qm/v2/mof/registrant',
  ...
  Dxc_Model_Cifs_AnonymousCorpse: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-cifs-anonymous-corpse-service/api/qm/v2/cifs/anonymous-corpse',
    },
    'queryPattern': {
  ...
  Dxc_Model_Rtp_MissingCarCase: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-rtp-missing-car-service/api/qm/v2/rtp/missing-car'
    },
    'queryPattern': {
    },
    'basicSearch': [
  ...
  Dxc_Model_Rtp_MissingPersonCase: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-rtp-missing-person-case-service/api/qm/v2/rtp/missing-person-case'
    },
    'queryPattern': {
    },
    'basicSearch': [
  ...
  Dxc_Model_Dbd_CommercialRegistrant: [{
    ...
    'category': '',
    'url': {
      'production': 'dxc-qm-dbd-juristic-registration-service/api/qm/v2/dbd/juristic-registration'
    },
    'queryPattern': {
    },
    'basicSearch': [
  ...
  Dxc_Model_Jfo_Jfo_Case: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-jfo-case-service/api/qm/v2/jfo/jfo-case'
    },
    'queryPattern': {
    },
    'basicSearch': [
  ...
  Dxc_Model_Cifs_MissingPerson: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-cifs-missing-person-service/api/qm/v2/cifs/missing-persons'
    },
    'queryPattern': {
    },
    'basicSearch': [
  ...
  Dxc_Model_Cifs_Corpse: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-cifs-corpse-service/api/qm/v2/cifs/corpse',
    },
    'queryPattern': {
      'searchBycitizenCardNumber': '?anonymousCorpseNumber=1&page=0&size=100&sortDirection=ASC',
      'searchByfirstName': '?firstName=1234&size=100&sortDirection=ASC',
  ...
  Dxc_Model_Rtp_Criminal: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-rtp-criminal-service/api/qm/v2/rtp/criminal'
    },
    'queryPattern': {
    },
    'basicSearch': [
  ...
  Dxc_Model_Dlt_DriverLicenseNew: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-dlt-driver-license-service/api/qm/dlt/driver-licenses/v2'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?criteria="driverLicense.citizenCardNumber={{citizenNumber}}"',
    },
    'basicSearch': [
      { 'title': 'เลขประจำตัวประชาชน', 'name': 'citizenCardNumber', 'type':'text', 'maxlength': '13', 'pattern':'[0-9]{13}', 'keypress':true }
    ],
    'grid': [{
      'cells': [
  ...
  Dxc_Model_Dlt_CarLicenseNew: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-dlt-vehicle-license-service/api/qm/v2/dlt/vehicle-licenses'
    },
    'queryPattern': {
  ...
  Dxc_Model_Sso_EmployeeEmployment: [{
    ...
    'grid': [{
      'cells': [
        ...
        { 'id': 'empBirthDate', 'title': 'เกิดวันที่', 'width': '120px', 'align': 'center' },
      ],
      'widths': '[150,150,150,100,150,70]'
    }]
  }],
  ...
  Dxc_Model_Agoth_IncidentLocation: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-ago-incident-location-service/api/qm/v2/ago/incident-locations'
    },
    'queryPattern': {
  ...
  Dxc_Model_Agoth_ChargeVictim: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-ago-charge-victim-service/api/qm/v2/ago/charge-victims'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?criteria="driverLicense.citizenCardNumber={{citizenNumber}}"',
    },
    'basicSearch': [
      { 'title': 'เลขบัตรประชาชนผู้เสียหาย', 'name': 'citizenId', 'maxlength': '13', 'pattern':'[0-9]{13}', 'type':'text', 'keypress':true }
    ],
    'grid': [{
      'cells': [
  ...
  Dxc_Model_Agoth_CaseProsecutionAttorney: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-ago-case-prosecution-attorney-service/api/qm/v2/ago/case-prosecution-attorneys'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?criteria="driverLicense.citizenCardNumber={{citizenNumber}}"',
    },
  ...
  Dxc_Model_Doc_Remandee: [{
    ...
    'basicSearch': [
      { 'title': 'เลขประจำตัวประชาชน', 'name': 'citizenCardNumber', 'maxlength': '13', 'pattern':'[0-9]{13}', 'type':'text', 'keypress':true },
      { 'title': 'เลขผู้ต้องขัง', 'name': 'prisonerId', 'pattern':'[0-9]' },
      { 'title': 'ชื่อ', 'name': 'firstName', 'pattern':'^[a-zA-Z\s]+$|^[ก-๏\s]+$' },
      { 'title': 'นามสกุล', 'name': 'lastName', 'pattern':'^[a-zA-Z\s]+$|^[ก-๏\s]+$' },
  ...
  Dxc_Model_Dopa_Moi_PersonChangenamePrimary: [{
    ...
    'grid': [{
      'cells': [
        ...
        { 'id': 'docDate', 'title': 'ปีพ.ศ. เดือน วันที่ ออกหนังสืออนุญาต', 'width': '120px', 'align': 'center' },
      ],
      'widths': '[150,150,150,100,150,70]'
    }]
  }],
  // ฐานข้อมูลบุคคลพ้นโทษ
  ...
  Dxc_Model_Idb_DirectoryDimensionPerson: [{
    ...
    'basicSearch': [
      { 'title': 'เลขบัตรประชาชนต้องหา/จำเลย', 'name': 'accusedCitizenId', 'maxlength': '13', 'pattern':'[0-9]{13}', 'type':'text', 'keypress':true },
  ...
  Dxc_Model_Sso_Employment: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-sso-employee-employment-service/api/qm/v2/sso/employments/'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?criteria="driverLicense.citizenCardNumber={{citizenNumber}}"',
    },
  ...
  Dxc_Model_Coj_ArrestWarrants: [{
    ...
    'category': 'general',
    'url': {
      'production': 'dxc-qm-coj-arrest-warrant-service/api/qm/v2/coj/arrest-warrants'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?criteria="driverLicense.citizenCardNumber={{citizenNumber}}"',
    },
  ...
  Dxc_Model_Rtp_CriminalRecord: [{
    ...
    'grid': [{
      'cells': [
        ...
        { 'id': 'warrantDate', 'title': 'วันที่ออกหมายจับ', 'width': '120px', 'align': 'center' },
  ...
  Dxc_Model_Coj_Judgement: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-coj-judgement-service/api/qm/coj/judgements',
      'production2': '/dxc-qm-coj-judgement-service/api/qm/coj/judgements/files'
    },
    'queryPattern': {
    },
    'basicSearch': [
      { 'title': 'หมายเลขคดีดำ (หมายเลขคดีดำตัวแรกขึ้นต้นด้วยพยัญชนะ ไม่มีจุด และไม่เว้นวรรค)', 'name': 'blackNo', 'pattern':'[ก-ฮ]+\d+/\d+', 'type':'text', 'keypress':true },
 ...
 Dxc_Model_Sso_Selected_Hospital: [{
  ...
  'category': 'general',
  'url': {
      'production': '/dxc-qm-sso-select-hospital-service/api/qm/v2/sso/select-hospitals'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?criteria="driverLicense.citizenCardNumber={{citizenNumber}}"',
    },
    ...
    'grid': [{
      'cells': [
        ...
        { 'id': 'person.lastName', 'title': 'สกุลประกันตน', 'width': '120px', 'align': 'center' },
  ...
  Dxc_Model_Rtp_Warrant_Of_Arrest: [{
    ...
    'category': 'general',
    'url': {
      'production': '/api/qm/v2/rtp/arrest-warrants'
    },
    'queryPattern': {
      'searchBysubjectFullName': '?criteria="arrestWarrant.subjectFullName={{subjectFullName}}"',
      'searchBycourtName': '?criteria="arrestWarrant.courtName={{courtName}}"'
  ...
  Dxc_Model_Doc_Prisoner_Bankrupt: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-doc-prisoner-bankrupt-service/api/v2/doc/prisoners-bankrupt'
  ...
  Dxc_Model_Dop_Probationer_Narcotics: [{
    ...
    'category': 'criminalRecords',
    'url': {
      'production': '/dxc-qm-dop-probationer-narcotics-service/api/v2/dop/probationer-narcotics'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?userNin=1234&size=100&sortDirection=ASC',
      'searchByFirstName': '?userNin=1234&size=100&sortDirection=ASC',
  ...
  Dxc_Model_Dop_Fact_Finding_Report: [{
    ...
    'category': 'criminalRecords',
    'url': {
      'production': '/dxc-qm-dop-fact-finding-report-service/api/qm/dxc/fact-finding-report'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?userNin=1234&size=100&sortDirection=ASC',
      'searchByFirstName': '?userNin=1234&size=100&sortDirection=ASC',
  ...
  Dxc_Model_Doc_Absolute_Prisoner_Information_Before_Release_On_Probation: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-doc-absolute-prisoner-information-before-release-on-probation-service/api/doc/dxc-qm-doc-absolute-prisoner-information-service'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?criteria="driverLicense.citizenCardNumber={{citizenNumber}}"',
    },
  ...
  Dxc_Model_LOG_TYPE: [{
    'url': {
      'production': '/api/single-report1',
      'development': '/api/single-report1'
    }
  }],
