export const environment = {
  menu: [
    {
      icon: 'https://ww2.dxc.go.th/dxc-img/icons3/local_search.png',
      title: 'Single Report',
      url: '/#/dxcui0014/dxcui00141/รายงาน Single Report'
    },
    {
      icon: 'https://ww2.dxc.go.th/dxc-img/icons3/database_table.png',
      title: 'Local Search',
      url: '/localsearch'
    },
    {
      icon: 'https://ww2.dxc.go.th/dxc-img/icons3/statistic.png',
      title: 'ระบบรายสถิติ',
    },
    {
      icon: 'https://ww2.dxc.go.th/dxc-img/icons3/logofficon.png',
      title: 'ออกจากระบบ'
    }
  ],
  news: [
  ...
  download: [
    {
      icon: 'https://ww2.dxc.go.th/docs/files/public/contentmanagement/pdfprotect.png',
      filename: 'CopySafe PDF Reader',
      url: 'https://ww2.dxc.go.th/docs/files/public/contentmanagement/CopysafePDFreader_5.exe'
    },
    {
      icon: 'https://ww2.dxc.go.th/docs/files/public/contentmanagement/copysafeweb.jpg',
      filename: 'CopySafe Web',
      url: 'https://ww2.dxc.go.th/login/select-copysafe-web-plugin'
    },
    {
      icon: 'https://ww2.dxc.go.th/dxc-img/software/ami.jpg',
  ...
  manual: [
    {
      icon: 'https://ww2.dxc.go.th/docs/files/public/contentmanagement/pdfmanual_icon.jpg',
      filename: 'นโยบายความมั่งคงปลอดภัยระบบ DXC สาหรับผู้ใช้',
    ...
    },
    {
      ...
      url: 'https://ww2.dxc.go.th/docs/files/public/contentmanagement/FAQs_Dopa.pdf'
    },
    {
      icon: 'https://ww2.dxc.go.th/docs/files/public/contentmanagement/pdfmanual_icon.jpg',
      filename: 'คู่มือ(ฉบับ User)-Update Version 2.1.19-hotfix2',
      url: 'https://ww2.dxc.go.th/docs/files/public/contentmanagement/User_Manual_Update_13_08_2015_for_DXC_Ver2_1_19_hotfix2.pdf'
    },
    {
      icon: 'https://ww2.dxc.go.th/docs/files/public/contentmanagement/pdfmanual_icon.jpg',
      filename: 'คู่มือ(ฉบับ Admin)',
      url: 'https://ww2.dxc.go.th/docs/files/public/contentmanagement/DXC_admin_manual_1.pdf'
    },
    {
      icon: 'https://ww2.dxc.go.th/docs/files/public/contentmanagement/pdfmanual_icon.jpg',
      filename: 'คู่มือ(ฉบับ ผู้ใช้งานใหม่)-Update Version 2.1.19-hotfix2',
      url: 'https://ww2.dxc.go.th/docs/files/public/contentmanagement/Complete_NewUserManual_Ver_2_1_19_hotfix2.pdf'
    },
    {
      icon: 'https://ww2.dxc.go.th/docs/files/public/contentmanagement/pdf_24.png',
      filename: 'GovAMI DXC Client',
      url: 'https://dxc.go.th/wp-content/uploads/2020/govami/govami_dxc_63.exe'
    },
    {
      ...
      url: 'https://ww2.dxc.go.th/docs/files/public/contentmanagement/dxc_appointing_admin_template.doc'
    },
    {
      icon: 'https://ww2.dxc.go.th/docs/files/public/contentmanagement/pdf_24.png',
  ...
  otherlink: [
    {
      icon: 'https://ww2.dxc.go.th/dxc-img/browsersupport/chrome.png',
      filename: 'Google Chrome',
      url: 'https://www.google.com/intl/th/chrome/browser/'
    },
    {
      icon: 'https://ww2.dxc.go.th/dxc-img/software/microsoft_logo_56x56.png',
...
ซึ่งปัญหานี้กำลังประสานงานเพื่อหาทางแก้ไข`
    ...
    {
      header: 'ไม่สามารถดาวน์โหลดไฟล์ฟอร์แมต PDF หรือ ENC ได้เมื่อใช้เบราว์เซอร์ Google Chrome',
      icon: '',
    ...
    {
      header: 'การเปิดไฟล์รายงานจากระบบ DXC ที่มีนามสกุล .ENC',
      icon: '',
      details: `จะต้องติดตั้งโปรแกรม CopySafe PDF Reader ก่อน เมื่อเปิดรายงานด้วยโปรแกรม CopySafe PDF Reader
      โปรแกรมจะให้ล็อกอินก่อนเปิดรายงาน ให้หรอกอีเมลและรหัสผ่านเดียวกันกับที่ใช้เข้าสู่ระบบ DXC
      ดูวิธีติดตั้งและดาวน์โหลดโปรแกรมได้ที่ หน้าดาวน์โหลดโปแกรมและเอกสาร`
    }
  ],
  // headerauthen: 'Bearer eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJTdXp1WXpENGNVU3hIbGtvVnRSc2U1cExLSUNyNDdHNnFXQTBpUjVSb2VJIn0.-C4tOC5hOC4peC4peC4seC4geC4qeC4k--C4tOC4jeC4nuC4t-C4iiIsInBvc2l0aW9uIjoi4LmA4LiI4LmJ4Liy4Lir4LiZ4LmJ4Liy4LiX4Li14LmIIiwiZmFtaWx5X25hbWUiOiLguYDguIjguKPguLTguI3guJ7guLfguIoifQ.WjN4htS9l7hILHZQHNKTF0W_VqFmyQW8NJsIdQO0xdcE6ROPwMBgJJqZ9RrZATkqVABhafvcxuGKxT5gqXQxx4aJDbim2wReBXrDPH3WLSh71-hB1OjGkaWjU-F2R0tC4QI3JDlnF16mhYlBMX321pv4BEyoRpL2o7YR204EaYh5qv2CSy6mFxcj15zrwdDcNT_sogAE2bR8zQspb_FILgHQHfCSh71QSRmXyBFXnJuTghM2MVn516tIKA_Gx2J-LzEwasAPyGpoyQ0acgkRBHZq_BQlP8m5fEc1m7f6faK31Zf4otiloOt-IMfpvpc4mT_ZjIEnIAWc7iimlulD3g',
  token: 'eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJTdXp1WXpENGNVU3hIbGtvVnRSc2U1cExLSUNyNDdHNnFXQTBpUjVSb2VJIn0.-C4meC4seC4geC4h-C4suC4meC4geC4tOC4iOC4geC4suC4o-C4ouC4uOC4leC4tOC4mOC4o-C4o--C4j-C4tOC4nuC4pSDguKrguLjguILguIjguLTguJXguJXguYwiLCJwb3NpdGlvbiI6IuC5gOC4iOC5ieC4suC4q-C4meC5ieC4suC4l-C4teC5iCIsImZhbWlseV9uYW1lIjoi4Liq4Li44LiC4LiI4Li04LiV4LiV4LmMIiwiZW1haWwiOiJwYXRpcG9uLnN1a2ppdEBnbWFpbC5jb20ifQ.F0ec_m0gVgB36YgEWYtr4Au6zHwn-qL-rpAaJ_iTOEAWHCv8d2X6YpwoBESZ8H5dPcCpDvUUVAKSeWq6qiPG2M9ZxqSfnN_R1MUhPffuBlEUEDaVBPZbyDzcFTuF0Xe4oaG0mwpUMB-iLrimPvpkrRygQH77czczmUW57m-Nxs8X0R4Uqd4rVRtd4oysWhlicRzCxSMeixYIhexR6QrpM2SU8nwZ51lsCVQ6Ifj7JdEQQW66yKi5eD5m7OlYq_FTMht8_1bQ4R817XR9mJZRa7UMMDs1tSNOnlEVj592iJ4ouq23_axdSirLWk6HJTH4BpReJpQXj38TmI5BipzWQg',
  baseUrl: 'http://localhost:4200',
  production: false,
  apiUrl: 'https://search-stg.dxc.go.th/api/sso/access-token',
    ...
    'sub': [
      {
        ...
        dop: {
          ...
          sub: [{
            ...
            factFindingReport: {
              title: 'ผลการสืบเสาะ (รายงานการสืบเสาะข้อเท็จจริง (แบบ ส.2 – 46))',
              url: '/factFindingReport/search',
              img: 'assets/dist/img/dxc-img/symbol/datatype/32/dop-probationee.png',
              model: 'Dxc_Model_Dop_Fact_Finding_Report',
              remark1: 'ทดสอบ',
              schema: 'dop-fact-finding-report',
              schemaGroup: 'fact-finding-report',
              service: 'factFindingReportService',
              report: 'ReportDopFactFindingReport',
              db: 'dop-fact-finding-reportdb',
              singleSearch: 'citizenCardNumber',
        ...
        djop: {
          ...
          sub: [{
            juvenileOffender: {
              ...
              remark1: `เชื่อมกับระบบของกรมพินิจฯ ระบบใหม่แล้ว เป็นข้อมูลปัจจุบัน ปรับปรุงข้อมูลใหม่วันละครั้ง
              (อนุญาตให้ค้นหาข้อมูลได้เฉพาะกรมราชทัณฑ์ , กรมคุมประพฤติและสำนักงานปลัดกระทรวงยุติธรรมเท่านั้น)`,
        ...
        doc: {
          ...
          sub: [{
            ...
            absolutePrisonerInformationBeforeReleaseOnProbation: {
              title: 'แบบบันทึกข้อมูลนักโทษเด็ดขาดก่อนปล่อยคุมประพฤติ (แบบ ส.1 - 46)',
              url: '/absolutePrisonerInformationBeforeReleaseOnProbation/search',
              img: 'assets/dist/img/dxc-img/symbol/datatype/32/doc-prisoner.png',
              model: 'Dxc_Model_Doc_Absolute_Prisoner_Information_Before_Release_On_Probation',
              remark1: 'ทดสอบ',
              schema: 'doc-absolute-prisoner-information',
              schemaGroup: 'absolute-prisoner-information-before-release-on-probation',
              service: 'absolutePrisonerInformationBeforeReleaseOnProbationService',
              report: 'ReportDocAbsolutePrisonerInformationBeforeReleaseOnProbation',
              db: 'doc-absolute-prisoner-information-before-release-on-probationdb',
              // singleSearch: 'citizenCardNumber',
              // singleSearchFnameLname: 'FnameLname',
              countDb: 'allgetion'
            },
        ...
        rlpd: {
          ...
          sub: [{
            ...
            crimedefendantcompensation: {
              ...
              db: 'crimeDefendantCompensationdb',
        ...
        cifs: {
          ...
          sub: [{
            ...
            reportverification: {
              ...
              url: '',
              img: 'assets/dist/img/dxc-img/symbol/datatype/32/cifs-reportverification.png',
        ...
        dol: {
          ...
          sub: [{
            landandcondominiumtitles: {
              ...
              db: 'moidollandandcondominiumtitlesdb',
              singleSearch: 'citizenCardNumber'
            },
          }]
        },
        ...
        nacc: {
          ...
          sub: [{
            corruptionaccuseds: {
              ...
              db: 'MoiNaccCorruptionAccusedsdb',
              singleSearch: 'citizenCardNumber'
            },
          }]
        },
        ...
        nhso: {
          ...
          sub: [{
            healthinsuranceright: {
              ...
              db: 'moi-nhso-health-insurance-rightsdb',
              singleSearch: 'citizenCardNumber'
            },
          }]
        },
        ...
        dsd: {
          ...
          sub: [{
            workforcedevelopments: {
              ...
              db: 'MoiDsdWorkforceDevelopmentsdb',
              singleSearch: 'citizenCardNumber'
            },
          }]
        },
        ...
        //   titleEn: 'msdhs',
        //   url: '/msdhs',
        //   img: 'assets/dist/img/dxc-img/symbol/institute/32/msdhs.png',
        //   sub: [{
        //     newbornbabies: {
        ...
        //   titleEn: 'rtp',
        //   url: '/rtp',
        //   img: 'assets/dist/img/dxc-img/symbol/institute/32/rtp.png',
        //   sub: [{
        //     missingcarcase: {
        ...
        //       remark1: 'ทดสอบ',
        //       schema: 'rtp-travel-information',
        //       schemaGroup: 'travel-information',
        ...
        //       remark1: 'ข้อมูลจากระบบเก่า และไม่มีการปรับปรุ่งแล้วตั้งแต่ พฤษภาคม 2556',
        //       schema: 'arrest-warrant-current',
        //       service: 'warrantOfArrestService',
        //       report: 'ReportRtpWarrantOfArrest',
        //       db: 'warrantOfArrestdb',
        //       singleSearch: 'accusedNin'
        //     },
        ...
        //   titleEn: 'jfo',
        //   url: '',
        //   img: 'assets/dist/img/dxc-img/symbol/institute/16/jfo.png',
        //   sub: [{
        //     jfoCase: {
        ...
        agoth: {
          ...
          titleEn: 'agoth',
          url: '',
          img: 'assets/dist/img/dxc-img/symbol/institute/16/agoth.png',
          sub: [{
            attorneymaincases: {
            ...
            incidentlocation: {
              ...
              db: 'incidentlocationdb',
              singleSearch: 'citizenCardNumber'
            },
            chargeSubject: {
              title: 'ฐานข้อมูลผู้ต้องหา/จำเลย',
            ...
            attorneySubcase: {
              ...
              db: 'attorneySubcasedb',
            },
            attorneyCaseManagement: {
              title: 'ฐานข้อมูลคำสั่งอัยการ',
              url: '/attorney-case-management/search',
              img: 'assets/dist/img/dxc-img/symbol/datatype/32/attorney-case-management.png',
              ...
              db: 'caseProsecutionAttorneyOrderdb',
            },
            caseProsecutionAttorney: {
              title: 'ฐานข้อมูลคำสั่งอัยการ2',
              url: '/attorney-case-management/search',
        ...
        //   titleEn: 'doe',
        //   url: '',
        //   img: 'assets/dist/img/dxc-img/symbol/institute/16/doe.png',
        //   sub: [{
        //     alienworkforces: {
        ...
        sso: {
          ...
          titleEn: 'sso',
          url: '/sso',
          img: 'assets/dist/img/dxc-img/symbol/institute/32/sso.png',
          sub: [{
            employeeEmployment: {
              title: 'ผู้ประกันตน',
            ...
            selectedhospital: {
              ...
              remark1: 'อยู่ในระหว่างปรับปรุง ไม่สามารถใช้งานได้ในขณะนี้',
  ...
  Dxc_Model_Dopa_Citizen: [{
    ...
    'url': {
      'production': '/dxc-qm-dopa-person-service/api/v2/dopa/persons',
    ...
    'basicSearch': [
      { 'title': 'เลขประจำตัวประชาชน', 'name': 'citizenCardNumber' },
  ...
  // ฐานข้อมูลผู้ขอออกหนังสือผ่านแดนทั้งหมด(รอแก้ไขเป็นทะเบียนราษฏร)
  Dxc_Model_Dopa_Moi_Persons: [{
    ...
    'basicSearch': [
      { 'title': 'เลขบัตรประชาชน', 'name': 'citizenCardNumber' },
    ],
    'grid': [{
      'cells': [
  ...
  Dxc_Model_Nhso_Moi_Health_Insurance_Rights: [{
    ...
    'basicSearch': [
      { 'title': 'เลขประจำตัวประชาชน', 'name': 'personId' },
  ...
  Dxc_Model_Oncb_NarcoticOffender: [{
    ...
    'category': 'criminalRecords',
    'url': {
      'production': '/dxc-qm-oncb-narcotic-offender-service/api/v2/doc/narcotic-offender',
    },
    'queryPattern': {
    ...
    'basicSearch': [
      ...
      { 'title': 'ชื่อ', 'name': 'firstname' },
      { 'title': 'นามสกุล', 'name': 'lastname' },
      { 'title': 'ปีรายงาน', 'name': 'reportedyear' }
    ],
  ...
  Dxc_Model_Dop_Probationer: [{
    ...
    'category': 'criminalRecords',
    'url': {
      'production': '/dxc-qm-dop-probationer-service/api/v2/dop/probationers'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?userNin=1234&size=100&sortDirection=ASC',
    ...
    'basicSearch': [
      ...
      { 'title': 'ชื่อ', 'name': 'firstName' },
      { 'title': 'นามสกุล', 'name': 'lastName' },
      { 'title': 'ปีทะเบียน', 'name': 'caseRegistrationYear' }
  ...
  Dxc_Model_Djop_JuvenileOffender: [{
    ...
    'category': 'criminalRecords',
    'url': {
      'production': '/dxc-qm-djop-juvenile-offender-service/api/v2/djop/juvenile-offenders'
  ...
  Dxc_Model_Doc_Prisoner: [{
    ...
    'category': 'criminalRecords',
    'url': {
      'production': '/dxc-qm-doc-prisoner-service/api/v2/doc/prisoners'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?userNin=1234&size=100&sortDirection=ASC',
      'searchByFirstName': '?userNin=1234&size=100&sortDirection=ASC',
    ...
    'basicSearch': [
      ...
      { 'title': 'ชื่อ', 'name': 'firstName' },
      { 'title': 'นามสกุล', 'name': 'lastName' },
      { 'title': 'โทษฐาน', 'name': 'allegation', 'class': 'autocomplete', 'source': 'prison' }
    ],
    'list': [
      {
        'cells': [
  ...
  Dxc_Model_Doc_Reg_seize: [{
    ...
    'category': 'criminalRecords',
    'url': {
      'production': '/dxc-qm-doc-reg-seize-service/api/v2/doc/reg-seizes',
  ...
  Dxc_Model_Rlpd_Requestors: [{
    ...
    'category': 'criminalRecords',
    'url': {
      'production': '/dxc-qm-rlpd-requestor-service/api/am/api/rlpd/complainants'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?userNin=1234&size=100&sortDirection=ASC',
      'searchByFirstName': '?userNin=1234&size=100&sortDirection=ASC',
    ...
    'basicSearch': [
      { 'title': 'เลขประจำตัวประชาชน', 'name': 'personNationalIdentificationId' },
      { 'title': 'ชื่อ', 'name': 'personGivenName' },
      { 'title': 'นามสกุล', 'name': 'personSurName' }
    ],
    'grid': [{
      'cells': [
  ...
  Dxc_Model_Rlpd_CrimeDefendantCompensation: [{
    ...
    'category': 'criminalRecords',
    'url': {
      'production': '/dxc-qm-rlpd-crime-defendant-compensation-service/api/qm/v2/rlpd/crime-defendant-compensation'
    },
    'queryPattern': {
    },
    'basicSearch': [
      { 'title': 'เลขคดี', 'name': 'caseId' },
      { 'title': 'เลขประจำตัวประชาชน', 'name': 'dftCitizenId', 'maxlength' : '13' },
      { 'title': 'ชื่อ-สกุล', 'name': 'dftAttorneyFullName' }
    ],
    'grid': [{
      'cells': [
        { 'id': 'caseId', 'title': 'เลขคดี', 'width': '120px', 'align': 'center' },
  ...
  Dxc_Model_Rlpd_CrimeVictimCompensation: [{
    ...
    'category': 'criminalRecords',
    'url': {
      'production': '/dxc-qm-rlpd-crime-victim-compensation-service/api/qm/v2/rlpd/crime-victim-compensation'
    },
    'queryPattern': {
    },
    'basicSearch': [
      { 'title': 'เลขคดี', 'name': 'caseId' },
      { 'title': 'เลขประจำตัวประชาชน', 'name': 'victimCitizenId', 'maxlength' : '13' },
      { 'title': 'ชื่อ-สกุล', 'name': 'victimAttorneyFullName' }
    ],
    'grid': [{
      'cells': [
        { 'id': 'caseId', 'title': 'เลขคดี', 'width': '120px', 'align': 'center' },
  ...
  Dxc_Model_Amlo_Moneylaunderingcase: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-amlo-money-laundering-case-service/api/v2/almo/money-laundering-case'
    ...
    'basicSearch': [
      ...
      { 'title': 'Case phase', 'name': 'caselastname' },
    ],
  ...
  Dxc_Model_Led_BankruptcyCase: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-led-bankruptcy-case-service/api/v2/led/bankruptcy-case',
    ...
    'basicSearch': [
      { 'title': 'เลขประจำตัวประชาชน', 'name': 'defendantid' },
      { 'title': 'ชื่อ', 'name': 'defendantname' },
      { 'title': 'นามสกุล', 'name': 'defendantSurname' },
    ],
  ...
  Dxc_Model_Mof_Registrant: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-fpo-welfare-registration-record-service/api/v2/fpo/welfare-registration-record',
  ...
  Dxc_Model_Cifs_AnonymousCorpse: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-cifs-anonymous-corpse-service/api/v2/cifs/anonymous-corpse',
    },
    'queryPattern': {
    ...
    'basicSearch': [
      { 'title': 'เลขที่ศพนิรนาม', 'name': 'anonymousCorpseNumber' },
    ],
  ...
  Dxc_Model_Dsi_Warrant: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-dsi-arrest-warrant-service/api/qm/dsi/arrest-warrants',
    },
    'queryPattern': {
      'searchByCitizenNumber': '?userNin=0000000000000',
      'searchByName': '?userNin=1234&size=100&sortDirection=ASC',
  ...
  Dxc_Model_Rtp_MissingCarCase: [{
    ...
    'basicSearch': [
      { 'title': 'หมวดอักษร', 'name': 'licensePlateNumberFrontPart' },
      { 'title': 'เลขทะเบียน', 'name': 'licensePlateNumberBackPart' },
      { 'title': 'ยี่ห้อ', 'name': 'brand' },
    ],
    'grid': [{
      'cells': [
  ...
  Dxc_Model_Rtp_ArrestWarrant: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-rtp-arrest-warrant-service/api/qm/v2/rtp/arrest-warrants/'
    },
    'queryPattern': {
    ...
    'grid': [{
      'cells': [
        { 'id': 'caseNo', 'title': 'หมายเลขคดี', 'width': '30%', 'align': 'center' },
        { 'id': 'accusedsFullName', 'title': 'ผู้ต้องหา', 'width': '20%', 'align': 'center' },
        { 'id': 'warrantNumber', 'title': 'เลขหมายจับ', 'align': 'center', 'width': '20%' },
        { 'id': 'warrantType', 'title': 'ประเภทหมายจับ	', 'width': '100px', 'align': 'center' },
        { 'id': 'warrantStatus', 'title': 'สถานะหมายจับ	', 'width': '100px', 'align': 'center' },
        { 'id': 'stationName', 'title': 'ชื่อสถานี', 'width': '100px', 'align': 'center' },
  ...
  Dxc_Model_Dbd_CommercialRegistrant: [{
    ...
    'basicSearch': [
      { 'title': 'รหัสนิติบุคคล', 'name': 'juristicId' },
    ],
    'grid': [{
      'cells': [
        { 'id': 'juristicId', 'title': 'รหัสนิติบุคคล', 'width': '120px', 'align': 'center' },
        { 'id': 'oldJuristicId', 'title': 'รหัสนิติบุคคลเดิม', 'width': '120px', 'align': 'center' },
        { 'id': 'juristicName', 'title': 'ชื่อนิติบุคคล(ไทย)', 'width': '120px', 'align': 'center' },
  ...
  Dxc_Model_Cifs_MissingPerson: [{
    ...
    'basicSearch': [
      { 'title': 'เลขที่บุคคลสูญหาย', 'name': 'missingPersonNumber' },
      { 'title': 'ชื่อ', 'name': 'personGivenName' },
      { 'title': 'นามสกุล', 'name': 'personSurName' },
    ],
    'grid': [{
      'cells': [
        { 'id': 'missingPersonNumber', 'title': 'เลขที่บุคคลสูญหาย', 'width': '120px', 'align': 'center' },
        { 'id': 'personGivenName', 'title': 'ชื่อ', 'width': '120px', 'align': 'center' },
        { 'id': 'personSurName', 'title': 'นามสกุล', 'width': '120px', 'align': 'center' },
        { 'id': 'personSex', 'title': 'เพศ', 'width': '120px', 'align': 'center' },
  ...
  Dxc_Model_Cifs_Corpse: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-cifs-corpse-service/api/v2/cifs/corpse',
    },
    'queryPattern': {
      'searchBycitizenCardNumber': '?anonymousCorpseNumber=1&page=0&size=100&sortDirection=ASC',
      'searchByfirstName': '?firstName=1234&size=100&sortDirection=ASC',
    ...
    'basicSearch': [
      { 'title': 'หมายเลขศพ', 'name': 'autopsyNumber' },
      { 'title': 'ชื่อผู้เสียชีวิต', 'name': 'personGivenName' },
      { 'title': 'นามสกุลผู้เสียชีวิต', 'name': 'personSurName' }
    ],
  ...
  Dxc_Model_Agoth_AttorneyMainCases: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-ago-attorney-main-case-service/api/qm/v2/ago/attorney-main-cases'
    },
    'queryPattern': {
    },
    'basicSearch': [
      { 'title': 'เลขรับที่โอนมา', 'name': 'refNumber' },
    ],
    'grid': [{
      'cells': [
  ...
  Dxc_Model_Rtp_Criminal: [{
    ...
    'basicSearch': [
      { 'title': 'เลขประจำตัวประชาชน', 'name': 'citizenCardNumber' },
      { 'title': 'ชื่อ', 'name': 'citizenCardNumber' },
      { 'title': 'นามสกุล', 'name': 'citizenCardNumber' },
      { 'title': 'ศาล', 'name': 'citizenCardNumber' }
    ],
    'grid': [{
      'cells': [
        { 'id': 'citizenCardNumber', 'title': 'เลขประจำตัวประชาชน', 'width': '120px', 'align': 'center' },
  ...
  Dxc_Model_Dlt_DriverLicenseNew: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-dlt-driver-license-service/dlt/driver-licenses'
    },
    'queryPattern': {
  ...
  Dxc_Model_Dlt_CarLicenseNew: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-dlt-vehicle-license-service/api/qm/dlt/vehicle-licenses/v1'
    },
    'queryPattern': {
  ...
  Dxc_Model_Sso_EmployeeEmployment: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-sso-employee-employment-service/api/qm/v2/sso/employees'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?criteria="driverLicense.citizenCardNumber={{citizenNumber}}"',
    },
    'basicSearch': [
      { 'title': 'เลขประจำตัวประชาชน', 'name': 'ssoNum' }
    ],
    'grid': [{
      'cells': [
  ...
  Dxc_Model_Agoth_Charge: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-ago-charge-service/api/qm/v2/ago/charges'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?criteria="driverLicense.citizenCardNumber={{citizenNumber}}"',
    },
    'basicSearch': [
      { 'title': 'เลขผู้ต้องหา/จำเลย', 'name': 'accusedId' }
    ],
    'grid': [{
      'cells': [
  ...
  Dxc_Model_Agoth_IncidentLocation: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-ago-charge-service/api/qm/v2/ago/incident-location'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?criteria="incidentLocation.citizenCardNumber={{citizenNumber}}"',
    },
    'basicSearch': [
      { 'title': 'ตำบลที่เกิดเหตุ', 'name': 'tambolName' },
      { 'title': 'อำเภอที่เกิดเหตุ', 'name': 'amphurName' },
      { 'title': 'จังหวัดที่เกิดเหตุ', 'name': 'provinceName' }
    ],
    'grid': [{
      'cells': [
  ...
  Dxc_Model_Agoth_ChargeSubject: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-ago-charge-subject-service/api/qm/v2/ago/charge-subjects'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?criteria="driverLicense.citizenCardNumber={{citizenNumber}}"',
    },
    'basicSearch': [
      { 'title': 'เลขบัตรประจำตัวประชาชนผู้ต้องหา', 'name': 'citizenId' }
    ],
    'grid': [{
      'cells': [
  ...
  Dxc_Model_Agoth_ChargeVictim: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-ago-charge-subject-service/api/qm/v2/ago/charge-victim'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?criteria="driverLicense.citizenCardNumber={{citizenNumber}}"',
    },
    'basicSearch': [
      { 'title': 'เลขบัตรประชาชนผู้เสียหาย', 'name': 'citizenId' }
    ],
    'grid': [{
      'cells': [
  ...
  Dxc_Model_Agoth_ChargeVerdict: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-ago-charge-verdict-service/api/qm/v2/ago/charge-verdicts'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?criteria="driverLicense.citizenCardNumber={{citizenNumber}}"',
    },
    'basicSearch': [
      { 'title': 'รหัสผู้ต้องหา/จำเลย', 'name': 'accusedId' }
    ],
    'grid': [{
      'cells': [
        { 'id': 'courtCode', 'title': 'รหัสศาล', 'width': '120px', 'align': 'center' },
  ...
  Dxc_Model_Agoth_AttorneySubcase: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-ago-attorney-subcase-service/api/qm/v2/ago/attorney-subcases'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?criteria="driverLicense.citizenCardNumber={{citizenNumber}}"',
    },
    'basicSearch': [
      { 'title': 'เลขรายงานการสอบสวนคดี', 'name': 'inqNumber' }
    ],
    'grid': [{
      'cells': [
  ...
  Dxc_Model_Agoth_Case_Prosecution_Attorney_Order: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-ago-case-prosecution-attorney-order-service/api/qm/v2/ago/case-prosecution-attorney-orders'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?criteria="driverLicense.citizenCardNumber={{citizenNumber}}"',
    },
    'basicSearch': [
      { 'title': 'รหัสคำสั่งอัยการ', 'name': 'commandId' }
    ],
    'grid': [{
      'cells': [
        { 'id': 'commandId', 'title': 'รหัสคำสั่งอัยการ', 'width': '120px', 'align': 'center' },
  ...
  Dxc_Model_Agoth_CaseProsecutionAttorney: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-ago-charge-subject-service/api/qm/v2/ago/case-prosecution-attorney'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?criteria="driverLicense.citizenCardNumber={{citizenNumber}}"',
    },
    'basicSearch': [
      { 'title': 'เลขบัตรประจำตัวผู้ต้องหา', 'name': 'accusedCitizenIds' }
    ],
    'grid': [{
      'cells': [
        { 'id': 'accusedsText', 'title': 'ชื่อผู้ต้องหา', 'width': '120px', 'align': 'center' },
        { 'id': 'generallcPoliceName', 'title': 'หน่วยงานเจ้าของสำนวน', 'width': '120px', 'align': 'center' },
        { 'id': 'generallcTypeName', 'title': 'ประเภทสารบบ', 'width': '120px', 'align': 'center' },
      ],
      'widths': '[150,150,150,100,150,70]'
    }]
  }],
  ...
  Dxc_Model_Doc_Remandee: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-doc-remandee-service/api/qm/v2/doc/remandees'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?criteria="driverLicense.citizenCardNumber={{citizenNumber}}"',
    },
  ...
  // // ฐานข้อมูลบุคคลพ้นโทษ (อยู่ระหว่างการทดสอบ) (อยู่ระหว่างการทดสอบ)
  // Dxc_Model_Doc_ReleasedPrisoners: [{
  //   'source': 'doc',
  //   'data': 'releasedprisoners',
  //   'uniqFields': [],
  //   'eventFields': [],
  //   'type': 'person',
  //   'category': 'general',
  //   'url': {
  //     'production': '/dxc-qm-doc-released-prisoner-service/api/qm/v2/doc/released-prisoners'
  //   },
  //   'queryPattern': {
  //     'searchByCitizenNumber': '?criteria="driverLicense.citizenCardNumber={{citizenNumber}}"',
  //   },
  ...
  Dxc_Model_Doc_PrisonerImages: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-doc-prisoner-image-service/api/qm/v2/doc/prisoner-images'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?criteria="driverLicense.citizenCardNumber={{citizenNumber}}"',
    },
    'basicSearch': [
      { 'title': 'เลขบัตรประชาชนผู้ต้องขัง', 'name': 'citizenCardNumber', 'maxlength' : '13' },
      { 'title': 'เลขผู้ต้องขัง', 'name': 'prisonerId' },
    ],
    'grid': [{
      'cells': [
  ...
  Dxc_Model_Doc_ReleasedOffender: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-dxc-released-offender-service/api/qm/v2/idb/released-offender'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?criteria="driverLicense.citizenCardNumber={{citizenNumber}}"',
    },
  ...
  Dxc_Model_Idb_DirectoryDimensionCase: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-ago-directory-dimension-case-service/api/qm/v2/ago/directory-dimension-case'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?criteria="driverLicense.citizenCardNumber={{citizenNumber}}"',
    },
    ...
    'grid': [{
      'cells': [
        ...
        { 'id': 'generallcBlackFile', 'title': 'เลขคดีดำ', 'width': '120px', 'align': 'center' },
        { 'id': 'generalCourtName', 'title': 'ชื่อศาล', 'width': '120px', 'align': 'center' },
        { 'id': 'generallcRedFile', 'title': 'เลขคดีแดง', 'width': '120px', 'align': 'center' },
        { 'id': 'generalCourtName', 'title': 'ชื่อศาล', 'width': '120px', 'align': 'center' },
        { 'id': 'generalInqdetail', 'title': 'รายละเอียดข้อมูลคดี', 'width': '120px', 'align': 'center' },
        { 'id': 'year', 'title': 'ปี', 'width': '120px', 'align': 'center' },
      ],
      'widths': '[150,150,150,100,150,70]'
    }]
  ...
  Dxc_Model_Idb_DirectoryDimensionPerson: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-ago-directory-dimension-persons-service/api/qm/v2/ago/directory-dimension-persons'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?criteria="driverLicense.citizenCardNumber={{citizenNumber}}"',
    },
    'basicSearch': [
      { 'title': 'เลขบัตรประชาชนต้องหา/จำเลย', 'name': 'accusedCitizenId', 'maxlength': '13', 'pattern':'[0-9]{13}' },
      { 'title': 'เลขบัตรประชาชนผู้เสียหาย', 'name': 'complainantCitizenId', 'maxlength': '13', 'pattern':'[0-9]{13}' },
    ],
    'grid': [{
      'cells': [
        ...
        { 'id': 'courtresultJudgementDetail', 'title': 'รายละเอียดข้อมูลส่วนบุคคล', 'width': '120px', 'align': 'center' },
  ...
  Dxc_Model_Sso_Employment: [{
    ...
    'basicSearch': [
      { 'title': 'เลขบัตรประชาชน', 'name': 'ssoNum', 'maxlength': '13', 'pattern':'[0-9]{13}' },
    ],
    'grid': [{
      'cells': [
        { 'id': 'companyName', 'title': 'ชื่อบริษัท', 'width': '120px', 'align': 'center' },
        { 'id': 'expStartDateText', 'title': 'วันที่', 'width': '120px', 'align': 'center' },
  ...
  Dxc_Model_Dep_Moi_Cripple: [{
    ...
    'grid': [{
      'cells': [
        { 'id': 'PERSON_CODE', 'title': 'เลขประจำตัวประชาชน', 'width': '120px', 'align': 'center' },
        { 'id': 'PERSON_NAME', 'title': 'ชื่อ-สกุล', 'width': '120px', 'align': 'center' },
        { 'id': 'DEFORM_NAME', 'title': 'ประเภทความพิการ', 'width': '120px', 'align': 'center' },
      ],
      'widths': '[150,150,150,100,150,70]'
    }]
  }],
  ...
  Dxc_Model_Coj_ArrestWarrants: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-coj-arrest-warrant-service/api/v2'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?criteria="driverLicense.citizenCardNumber={{citizenNumber}}"',
    },
  ...
  Dxc_Model_Coj_JudgementSummarys: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-coj-judgement-summary-service/api/v2/coj/judgement-summary'
    },
    'queryPattern': {
    },
    'basicSearch': [
      { 'title': 'หมายเลขคดีดำ', 'name': 'caseNo' },
      { 'title': 'รหัสศาล', 'name': 'court' },
      { 'title': 'หมายเลขคดีดำ-รหัสศาล', 'name': 'fullName', 'type': 'hidden'}
    ],
    'grid': [{
      'cells': [
        { 'id': 'caseNo', 'title': 'หมายเลขคดีดำ', 'width': '120px', 'align': 'center' },
        { 'id': 'redNo', 'title': 'หมายเลขคดีแดง', 'width': '120px', 'align': 'center' },
        { 'id': 'court', 'title': 'ชื่อศาล', 'width': '120px', 'align': 'center' },
        { 'id': 'caseDate', 'title': 'วันที่รับฟ้อง', 'width': '120px', 'align': 'center' },
        { 'id': 'judgingDate', 'title': 'วันที่ตัดสินคดี', 'width': '120px', 'align': 'center' },
      ],
      'widths': '[150,150,150,100,150,70]'
    }]
  }],
  ...
  Dxc_Model_Mof_register_Of_Taxpayers: [{
    ...
    'category': 'general',
    'url': {
      'production': '/dxc-qm-coj-judgement-summary-service/api/qm/v2/coj/judgement-summarys'
    },
    'queryPattern': {
    },
    'basicSearch': [
  ...
  Dxc_Model_Jfo_Jfo_Case64: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-jfo-case64-service/api/qm/v2/jfo/jfo-case64'
    },
    'queryPattern': {
    },
    'basicSearch': [
  ...
  Dxc_Model_Rtp_CriminalCase: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-rtp-criminal-case-service/api/qm/v2/rtp/criminal-case'
    },
    'queryPattern': {
    },
    'basicSearch': [
      // { 'title': 'ชื่อ-ผู้แจ้ง/ผู้เสียหาย', 'name': 'victimName', 'pattern':'^[a-zA-Z\s]+$|^[ก-๏\s]+$' },
  ...
  Dxc_Model_Rtp_TravelInformation: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-rtp-travel-information-service/api/qm/v2/rtp/travel-information'
    },
    'queryPattern': {
    },
    'basicSearch': [
      // { 'title': 'ชื่อ-ผู้แจ้ง/ผู้เสียหาย', 'name': 'victimName', 'pattern':'^[a-zA-Z\s]+$|^[ก-๏\s]+$' },
      { 'title': 'หมายเลขพาสพอร์ท', 'name': 'tdtno' }
    ],
    'grid': [{
      'cells': [
        ...
        { 'id': 'sex', 'title': 'เพศ', 'width': '120px', 'align': 'center' },
        { 'id': 'nationenm', 'title': 'สัญชาติ', 'width': '120px', 'align': 'center' },
      ],
      'widths': '[150,150,150,100,150,70]'
    }]
  }],
  ...
  Dxc_Model_Rtp_TrafficCase: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-rtp-traffic-case-service/api/qm/v2/rtp/traffic-case'
    },
    'queryPattern': {
    },
    'basicSearch': [
      { 'title': 'เลขบัตรประชาชน-ผู้ต้องหา', 'name': 'citizenCardNumber', 'maxlength': '13', 'pattern':'[0-9]{13}', 'type':'text', 'keypress':true }
    ],
    'grid': [{
      'cells': [
        { 'id': 'citizenCardNumber', 'title': 'เลขบัตรประชาชน-ผู้ต้องหา', 'width': '120px', 'align': 'center' },
        { 'id': 'accusedsName', 'title': 'ชื่อ-ผู้ต้องหา', 'width': '120px', 'align': 'center' },
        { 'id': 'caseId', 'title': 'เลขคดี', 'width': '120px', 'align': 'center' },
        { 'id': 'stationId', 'title': 'รหัสสถานี', 'width': '120px', 'align': 'center' },
        { 'id': 'stationName', 'title': 'ชื่อสถานี', 'width': '120px', 'align': 'center' },
        { 'id': 'regionalHqt', 'title': 'บช./ภาค', 'width': '120px', 'align': 'center' },
        { 'id': 'provPoliceHqt', 'title': 'บก./ภ.จว', 'width': '120px', 'align': 'center' }
      ],
      'widths': '[150,150,150,100,150,70]'
    }]
  }],
  ...
  Dxc_Model_Rtp_CriminalRecord: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-rtp-criminal-record-service/api/qm/v2/rtp/criminal-record'
    },
    'queryPattern': {
    },
    'basicSearch': [
    ...
    'grid': [{
      'cells': [
        ...
        { 'id': 'firstName', 'title': 'ชื่อ', 'width': '120px', 'align': 'center' },
        { 'id': 'lastName', 'title': 'สกุล', 'width': '120px', 'align': 'center' },
        { 'id': 'crimeCase', 'title': 'กระทำความผิดฐาน', 'width': '120px', 'align': 'center' },
        { 'id': 'warrantNo', 'title': 'หมายจับที่', 'width': '120px', 'align': 'center' },
        { 'id': 'wantD', 'title': 'วันที่ออกหมายจับ', 'width': '120px', 'align': 'center' },
        { 'id': 'org', 'title': 'สถานที่ออกหมายจับ', 'width': '120px', 'align': 'center' }
      ],
      'widths': '[150,150,150,100,150,70]'
    }]
  }],
  ...
  Dxc_Model_Coj_Judgement: [{
    ...
    'category': 'general',
    'url': {
      'production': '/judgement/api/qm/coj/judgements',
      'production2': '/dxc-qm-coj-judgement-service/api/qm/coj/judgements/files'
    },
    'queryPattern': {
    },
    'basicSearch': [
      { 'title': 'หมายเลขคดีดำ', 'name': 'blackNo' },
  ...
  Dxc_Model_Djop_JuvenileOffender65: [{
    ...
    'category': '',
    'url': {
      'production': '/dxc-qm-djop-juvenile-offender-2567-service/api/qm/v2/djop/juvenile-offender-2567'
    ...
    'basicSearch': [
      { 'title': 'เลขประจำตัวประชาชน', 'name': 'jvnCardId', 'maxlength': '13', 'pattern':'[0-9]{13}', 'type':'text', 'keypress':true }
    ...
    'grid': [{
      'cells': [
        ...
        // { 'id': 'jvnBirthDate', 'title': 'วันเกิด', 'align': 'center', 'width': '70px' },
  ...
  Dxc_Model_Sso_Selected_Hospital: [{
    ...
    'category': 'general',
    'url': {
      'production': '/api/qm/v2/sso/selected-hospital'
    },
    'queryPattern': {
      'searchByCitizenNumber': '?criteria="driverLicense.citizenCardNumber={{citizenNumber}}"',
    },
  ...
  Dxc_Model_Dop_Fact_Finding_Report: [{
    ...
    'grid': [{
      'cells': [
        ...
        { 'id': 'prison', 'title': 'เรื่อนจำ', 'width': '100px', 'align': 'center' },
        // { 'id': 'birthDateSrc', 'title': 'เรื่อนจำ', 'width': '100px', 'align': 'center' },
      ],
      'widths': '[100,100,200,100,200,200,200,200]'
    }]
  }
  ...
  Dxc_Model_Doc_Absolute_Prisoner_Information_Before_Release_On_Probation: [{
    ...
    'grid': [{
      'cells': [
        ...
        { 'id': 'firstName', 'title': 'ชื่อ', 'width': '120px', 'align': 'center' },
        { 'id': 'lastName', 'title': 'นามสกุล', 'width': '120px', 'align': 'center' },
        { 'id': 'redNo', 'title': 'นามสกุล', 'width': '120px', 'align': 'center' },
      ],
      'widths': '[150,150,150,100,150,70]'
    }]
  }],
  ...
  Dxc_Model_Userprofile: [{
    'url': {
      // 'production': '/api/v2/dxc/admin/policies',
      // 'production': '/dxc-self-service-service/api/registration/userdataacl/findaccount/',
      // 'production': '/dxc-self-service-service/api/registration/findgroudid/',
      'production': '/dxc-self-service-service/api/useraccount/userName/'
      // 'development': 'https://search.dxc.go.th/api/v2/dxc/admin/policies'
    },
  }
  ],
  Dxc_Model_Policies: [{
  ...
  Dxc_Model_Reason: [{
    'url': {
      'production': '/dxc-reason-service/dxc-search-service/api/reason/add/',
      'development': '/dxc-reason-service/dxc-search-service/api/reason/add/',
    },
  }
  ],
  ...
  Dxc_Model_Notice: [{
    'url': {
      'production': '/dxc-core-service/api/qm/dxc/notice/findAll',
      'development': '/dxc-core-service/api/qm/dxc/notice/findAll',
    },
  }],
  dataset: ['dopa-moi-dopa-person','dopa-moi-dopa-thai-id-cards','dopa-moi-dopa-addresses'],
  Dxc_Model_Count_ExpirDate: [{
    'url': {
      'production': '/api/countExpirDate/getCountExpirDate/',
      'development': '/dxc-self-service-service/api/countExpirDate/getCountExpirDate/',
    },
  }],
  Dxc_Model_Login_ThaiD: [{
    'url': {
      'production': '/dxc-login-thaid-service/api/login/thaid-linkage2/inset',
    },
  }],
};
